...
$schemeUrl = "schemes-major-grants.php";
?>
<body class="t2">
<?php 
                    ...
                    <div class="row">
                        <div class="col-12">
                            <ol>
                                ...
                                <li>Schemes</li>
                                <li><a href="<?php echo $schemeUrl;?>">Major Research Scheme</a></li>
                                <li>Apply Here</li>
                            </ol>
                            <h2>
                                ...
                                <br>
                                <p>
                                    Embark on an Extraordinary Research Voyage: Apply Now for the Major Research Project Scheme 
                                    <br>
                            ...
                            <div id="form_0" class="tabcontent inner-forms">
                                <div class="forms">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <label for="department" class="form-label star">Department</label>
                                            <input type="text" class="form-control" name="department" id="department" value="" oninput="validateInput(this)" placeholder="" aria-describedby="">
                                            <span class="error-msg col-md-12" id="department_error_msg"></span>
                                        </div>
                                ...
                                <div class="forms">
                                    <div class="row">
                                        <h3 class="mb-5">Co-Investigator I Details (if any)</h3>
                                        <div class="col-md-4 mb-4">
                                            <label for="co_inv_i_first_name" class="form-label">First Name</label>
                                            <input type="text" class="form-control" id="co_inv_i_first_name" name="co_inv_i_first_name" value="" oninput="validateInput(this)" placeholder="Enter first name" aria-describedby="first name">
                                            <span class="error-msg col-md-12" id="co_inv_i_first_name_error_msg"></span>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <label for="co_inv_i_middle_name" class="form-label">Middle Name</label>
                                            <div class="input-group mb-3">        
                                                <input type="text" class="form-control" id="co_inv_i_middle_name" name="co_inv_i_middle_name" value="" placeholder="Enter middle name" aria-describedby="middle name">
                                            </div>                                    
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <label for="lname" class="form-label">Last Name</label>
                                            <input type="text" class="form-control" id="co_inv_i_last_name" name="co_inv_i_last_name" value="" oninput="validateInput(this)" placeholder="Enter last name" aria-describedby="last name">
                                            <span class="error-msg col-md-12" id="co_inv_i_last_name_error_msg"></span>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <label for="basic-url" class="form-label">Gender</label>
                                            <br>
                                            <div class="form-check d-inline-block pt-1 ">
                                                <input class="form-check-input" type="radio" name="co_inv_i_gender" id="co_inv_i_gender1" value="male">
                                                <label class="form-check-label" for="co_inv_i_gender1">
                                                    Male
                                                </label>
                                            </div>
                                            <div class="form-check d-inline-block pt-1 ">
                                                <input class="form-check-input" type="radio" name="co_inv_i_gender" id="co_inv_i_gender2" value="female">
                                                <label class="form-check-label" for="co_inv_i_gender2">
                                                    Female
                                                </label>
                                            </div>
                                            <div class="form-check d-inline-block pt-1 ">
                                                <input class="form-check-input" type="radio" name="co_inv_i_gender" id="co_inv_i_gender3" value="other">
                                                <label class="form-check-label" for="co_inv_i_gender3">
                                                    other
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <label for="co_inv_i_dob" class="form-label">Date of Birth</label>
                                            <div class="input-group mb-3">        
                                                <input type="date" class="form-control" id="co_inv_i_dob" name="co_inv_i_dob" value="" placeholder="DD/MM/YYYY" aria-describedby="DOB">
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <label for="co_inv_i_phone_no" class="form-label">Mobile No.</label>
                                            <div class="input-group mb-3 input_field_shadow">
                                                <select id="co_inv_i_country_code" name="co_inv_i_country_code" value="" class="input-group-text merge_input_field">
                                                    <?php
                                                        foreach ($countryCodeArr as $key => $value) {
                                                            echo '<option value="'.$value['id'].'">'.$value['name'].'</option>';
                                                        }
                                                ...
                                                <input type="number" class="form-control" id="co_inv_i_phone_no" value="" aria-describedby="co_inv_i_phone_no">
                                            </div>
                                        </div>                    
                                        <div class="col-md-4 mb-4">
                                            <label for="co_inv_i_email" class="form-label">Email ID</label>
                                            <input type="email" class="form-control" name="co_inv_i_email" id="co_inv_i_email" value="" placeholder="Enter email id" aria-describedby="email">
                                            <span class="error-msg col-md-12" id="co_inv_i_email_error_msg"></span>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <label for="co_inv_i_designation" class="form-label">Designation</label>
                                            <input type="text" class="form-control" name="co_inv_i_designation" id="co_inv_i_designation" value="" oninput="validateInput(this)" placeholder="" aria-describedby="">
                                            <span class="error-msg col-md-12" id="co_inv_i_designation_error_msg"></span>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <label for="co_inv_i_qualification" class="form-label">Qualification (Highest)</label>
                                            <input type="text" class="form-control" name="co_inv_i_qualification" id="co_inv_i_qualification" value="" oninput="validateInput(this)" placeholder="" aria-describedby="">
                                            <span class="error-msg col-md-12" id="co_inv_i_qualification_error_msg"></span>
                                        </div>
                                        <div class="col-md-8 mb-4">
                                            <label for="co_inv_i_official_address" class="form-label">Official Address</label>
                                            <textarea class="form-control" name="co_inv_i_official_address" id="co_inv_i_official_address" oninput="validateInput(this)" cols="80" rows="1" placeholder=""></textarea>
                                            <span class="error-msg col-md-12" id="co_inv_i_official_address_error_msg"></span>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <label for="co_inv_i_department" class="form-label">Department</label>
                                            <input type="text" class="form-control" name="co_inv_i_department" id="co_inv_i_department" value="" oninput="validateInput(this)" placeholder="" aria-describedby="">
                                            <span class="error-msg col-md-12" id="co_inv_i_department_error_msg"></span>
                                        </div>
                                        <div class="col-md-12 mb-4">
                                            <label for="co_inv_i_specialisation" class="form-label">Specialisation(if any)</label>
                                            <textarea class="form-control" name="co_inv_i_specialisation" id="co_inv_i_specialisation" oninput="validateInput(this)" cols="80" rows="3" placeholder=""></textarea>
                                            <span class="error-msg col-md-12" id="co_inv_i_specialisation_error_msg"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="forms">
                                    <div class="row">
                                        <h3 class="mb-5">Co-Investigator II Details(if any)</h3>
                                        <div class="col-md-4 mb-4">
                                            <label for="co_inv_ii_first_name" class="form-label">First Name</label>
                                            <input type="text" class="form-control" id="co_inv_ii_first_name" name="co_inv_ii_first_name" value="" oninput="validateInput(this)" placeholder="Enter first name" aria-describedby="first name">
                                            <span class="error-msg col-md-12" id="co_inv_ii_first_name_error_msg"></span>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <label for="co_inv_ii_middle_name" class="form-label">Middle Name</label>
                                            <div class="input-group mb-3">        
                                                <input type="text" class="form-control" id="co_inv_ii_middle_name" name="co_inv_ii_middle_name" value="" placeholder="Enter middle name" aria-describedby="middle name">
                                            </div>                                    
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <label for="lname" class="form-label">Last Name</label>
                                            <input type="text" class="form-control" id="co_inv_ii_last_name" name="co_inv_ii_last_name" value="" oninput="validateInput(this)" placeholder="Enter last name" aria-describedby="last name">
                                            <span class="error-msg col-md-12" id="co_inv_ii_last_name_error_msg"></span>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <label for="basic-url" class="form-label">Gender</label>
                                            <br>
                                            <div class="form-check d-inline-block pt-1 ">
                                                <input class="form-check-input" type="radio" name="co_inv_ii_gender" id="co_inv_ii_gender1" value="male">
                                                <label class="form-check-label" for="co_inv_ii_gender1">
                                                    Male
                                                </label>
                                            </div>
                                            <div class="form-check d-inline-block pt-1 ">
                                                <input class="form-check-input" type="radio" name="co_inv_ii_gender" id="co_inv_ii_gender2" value="female">
                                                <label class="form-check-label" for="co_inv_ii_gender2">
                                                    Female
                                                </label>
                                            </div>
                                            <div class="form-check d-inline-block pt-1 ">
                                                <input class="form-check-input" type="radio" name="co_inv_ii_gender" id="co_inv_ii_gender3" value="other">
                                                <label class="form-check-label" for="co_inv_ii_gender3">
                                                    other
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <label for="co_inv_ii_dob" class="form-label">Date of Birth</label>
                                            <div class="input-group mb-3">        
                                                <input type="date" class="form-control" id="co_inv_ii_dob" name="co_inv_ii_dob" value="" placeholder="DD/MM/YYYY" aria-describedby="DOB">
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <label for="co_inv_ii_phone_no" class="form-label">Mobile No.</label>
                                            <div class="input-group mb-3 input_field_shadow">
                                                <select name="co_inv_ii_country_code" id="co_inv_ii_country_code" value="" class="input-group-text merge_input_field">
                                                    <?php
                                                        foreach ($countryCodeArr as $key => $value) {
                                                            echo '<option value="'.$value['id'].'">'.$value['name'].'</option>';
                                                        }
                                                ...
                                                <input type="number" class="form-control" id="co_inv_ii_phone_no" value="" aria-describedby="co_inv_ii_phone_no">
                                            </div>
                                        </div>                    
                                        <div class="col-md-4 mb-4">
                                            <label for="co_inv_ii_email" class="form-label">Email ID</label>
                                            <input type="email" class="form-control" name="co_inv_ii_email" id="co_inv_ii_email" value="" placeholder="Enter email id" aria-describedby="email">
                                            <span class="error-msg col-md-12" id="co_inv_ii_email_error_msg"></span>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <label for="co_inv_ii_designation" class="form-label">Designation</label>
                                            <input type="text" class="form-control" name="co_inv_ii_designation" id="co_inv_ii_designation" value="" oninput="validateInput(this)" placeholder="" aria-describedby="">
                                            <span class="error-msg col-md-12" id="co_inv_ii_designation_error_msg"></span>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <label for="co_inv_ii_qualification" class="form-label">Qualification (Highest)</label>
                                            <input type="text" class="form-control" name="co_inv_ii_qualification" id="co_inv_ii_qualification" value="" oninput="validateInput(this)" placeholder="" aria-describedby="">
                                            <span class="error-msg col-md-12" id="co_inv_ii_qualification_error_msg"></span>
                                        </div>
                                        <div class="col-md-8 mb-4">
                                            <label for="co_inv_ii_official_address" class="form-label">Official Address</label>
                                            <textarea class="form-control" name="co_inv_ii_official_address" id="co_inv_ii_official_address" oninput="validateInput(this)" cols="80" rows="1" placeholder=""></textarea>
                                            <span class="error-msg col-md-12" id="co_inv_ii_official_address_error_msg"></span>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <label for="co_inv_ii_department" class="form-label">Department</label>
                                            <input type="text" class="form-control" name="co_inv_ii_department" id="co_inv_ii_department" value="" oninput="validateInput(this)" placeholder="" aria-describedby="">
                                            <span class="error-msg col-md-12" id="co_inv_ii_department_error_msg"></span>
                                        </div>
                                        <div class="col-md-12 mb-4">
                                            <label for="co_inv_ii_specialisation" class="form-label">Specialisation(if any)</label>
                                            <textarea class="form-control" name="co_inv_ii_specialisation" id="co_inv_ii_specialisation" oninput="validateInput(this)" cols="80" rows="3" placeholder=""></textarea>
                                            <span class="error-msg col-md-12" id="co_inv_ii_specialisation_error_msg"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="forms">
                                                ...
                                                <div class="col-md-11">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-7 mb-4">
                                                            ...
                                                            <textarea class="form-control" name="institute_address[]" id="institute_address_1" oninput="validateInput(this)" cols="80" rows="1" placeholder="Institute Institute complete Address"></textarea>
                                ...
                                <div class="forms">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-4">
                                            ...
                                            <input type="number" class="form-control" id="proposed_amount" name="proposed_amount" value="0" min="0" oninput="validateInput(this)" placeholder="₹ 0 0 0 0" aria-describedby="number" readonly>
                                ...
                                <div class="forms">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <textarea class="form-control" name="project_location" id="project_location" oninput="validateInput(this)" onkeyup="validateWordCount('project_location','200')" cols="80" rows="2" placeholder="Highlight the reasons for choosing the location/site"></textarea>
                            ...
                            <div id="form_3" class="tabcontent">
                                <div class="forms">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-lg-12 mb-4" id="file_time_schedule_field">
                                            <label for="file_time_schedule" class="form-label star">Provide a Time Schedule of activities</label>
                                            <p>Give a bar diagram or GANTT chart on Quarterly basis (Max file size 1024KB) <?php include "layout/tooltip-i.php"; ?> </p>
                                            <div class="form-check col-md-12 col-lg-6" style="padding-left: 0;">
                                                <input type="file" id="file_time_schedule" name="file_time_schedule" placeholder="" class="form-control input-md" accept="application/pdf,.csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                            ...
                            <div id="form_4" class="tabcontent">
                                <div class="forms">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-4">
                                            <label for="specific_expertise_of_pi" class="form-label star">Highlight the specific expertise available with the PI and Co-PIs for executing the project</label>
                                        ...
                                        <div class="col-md-12 table-responsive mb-4">
                                            <label for="fname" class="form-label star">Role and responsibility of each of the Investigators</label>
                                            <p>People with specific expertise required for executing the project only shall be PI/Co-PIs </p>
                                            <table class="table table-stripped table-bordered border-light edu_details input_fields_wrap_invest_expertise">
                                                <thead class="table-light">
                                                    <th>Sr. No.</th>
                                                    <th>Name of the Investigators</th>
                                                ...
                                                <tbody>
                                                    <tr class="wrapper_row">
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control" name="invest_name[]" id="invest_name_1" value="" oninput="validateInput(this)" placeholder="Enter full name" aria-describedby="">
                                                            <span class="error-msg col-md-12" id="invest_name_1_error_msg"></span>
                                                        </td>
                                                        <td>
                                                            <input type="text" class="form-control" name="invest_role[]" id="invest_role_1" value="" oninput="validateInput(this)" placeholder="Enter role" aria-describedby="">
                                                            <span class="error-msg col-md-12" id="invest_role_1_error_msg"></span>
                                                        </td>
                                                        <td width="62px">
                                            ...
                                            <button type="button" class="btn link_btn add_field_button_invest_expertise" style="text-align: inherit;">+ Add Investigator</button>
                                        </div>
                                        <div class="col-md-12 table-responsive mb-4">
                                            <label class="star">Important publications by the Investigator(s) related to the theme of the proposal during the last 5 years</label>
                            ...
                            <div id="form_5" class="tabcontent">
                                <div class="forms">
                                    <div class="row">
                                        ...
                                        <p>The list of Projects implemented by the Principal Investigator, followed by Co-PI1, Co-PI 2 etc. should be given sequentially (if any)</p>
                                        <p class="mb-5"><strong>Note : </strong>Write NIL or NA if not applicable</p>

                                        <div class="col-md-12 table-responsive mb-4">
                                            <label class="star">Details of Projects Submitted to various funding agencies</label>
                                            <table class="table table-stripped table-bordered border-light edu_details input_fields_wrap_projectDetailsSubmitted">
                                                ...
                                                <tbody>
                                                    <tr class="wrapper_row">
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control" name="investigators_project_cost[]" id="investigators_project_cost_1" value="" min="0" oninput="validateInput(this)" placeholder="₹" aria-describedby="0000">
                                            ...
                                            <table class="table table-stripped table-bordered border-light edu_details input_fields_wrap_projectDetailsOngoing">
                                                ...
                                                <tbody>
                                                    <tr class="wrapper_row">
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control" name="investigators_ongoing_project_cost[]" id="investigators_ongoing_project_cost_1" value="" min="0" oninput="validateInput(this)" placeholder="₹" aria-describedby="0000">
                                            ...
                                            <table class="table table-stripped table-bordered border-light edu_details input_fields_wrap_projectDetailsCompleted">
                                                ...
                                                <tbody>
                                                    <tr class="wrapper_row">
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control" name="investigators_completed_project_cost[]" id="investigators_completed_project_cost_1" value="" min="0" oninput="validateInput(this)" placeholder="₹" aria-describedby="0000">
                            ...
                            <div id="form_7" class="tabcontent">
                                <div class="forms">
                                    <div class="row">
                                        ...
                                        <p>Provide names of at least three experts and/or institutions</p>
                                                ...
                                                <div class="col-md-10">
                                                    <div class="row">
                                                        <div class="form-group col-md-4 mb-4">
                                                            <label class="form-label star fw6" for="guide_name_1">Name</label>  
                                                        ...
                                                        <div class="form-group col-md-8 mb-4">
                                                            <label class="form-label star fw6" for="guide_address_1">Address</label>  
                                                            <textarea class="form-control" name="guide_address[]" id="guide_address_1" oninput="validateInput(this)" cols="80" rows="1" placeholder="Enter address"></textarea>
                                ...
                                <div class="forms">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 mb-5">
                                            ...
                                            <input type="number" id="budget_consolidated" name="budget_consolidated" value="" min="0" oninput="validateInput(this)" placeholder="₹ 0 " class="form-control" readonly>
                                        ...
                                        <div class="col-md-12 mb-5">
                                            ...
                                            <table class="table table-stripped table-bordered border-light edu_details budget_table">
                                                <thead class="table-light">
                                                    ...
                                                    <th class="year_field_3">Year 3 (Rs)</th>
                                                    <th>Total</th>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="year_field_3 non_recurring">
                                                            <input type="hidden" id="year_1_3" name="year_1_3" value="" min="0" oninput="validateInput(this)" onblur="convertNumberToDecimal(this)" onkeyup="calculateTotalBudgetForMinMaj(this)" placeholder="₹ 0" class="form-control text-end">
                                                            <span class="error-msg col-md-12" id="year_1_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="year_field_3 non_recurring">
                                                            <input type="number" id="year_2_3" name="year_2_3" value="" min="0" oninput="validateInput(this)" onblur="convertNumberToDecimal(this)" onkeyup="calculateTotalBudgetForMinMaj(this)" placeholder="₹ 0" class="form-control text-end" readonly>
                                                            <span class="error-msg col-md-12" id="year_2_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="year_field_3 non_recurring">
                                                            <input type="number" id="year_3_3" name="year_3_3" value="" min="0" oninput="validateInput(this)" onblur="convertNumberToDecimal(this)" onkeyup="calculateTotalBudgetForMinMaj(this)" placeholder="₹ 0" class="form-control text-end">
                                                            <span class="error-msg col-md-12" id="year_3_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="year_field_3 non_recurring">
                                                            <input type="number" id="year_4_3" name="year_4_3" value="" min="0" oninput="validateInput(this)" onblur="convertNumberToDecimal(this)" onkeyup="calculateTotalBudgetForMinMaj(this)" placeholder="₹ 0" class="form-control text-end">
                                                            <span class="error-msg col-md-12" id="year_4_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="year_field_3 non_recurring">
                                                            <input type="number" id="year_5_3" name="year_5_3" value="" min="0" oninput="validateInput(this)" onblur="convertNumberToDecimal(this)" onkeyup="calculateTotalBudgetForMinMaj(this)" placeholder="₹ 0" class="form-control text-end">
                                                            <span class="error-msg col-md-12" id="year_5_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="year_field_3 non_recurring">
                                                            <input type="number" id="year_6_3" name="year_6_3" value="" min="0" oninput="validateInput(this)" onblur="convertNumberToDecimal(this)" onkeyup="calculateTotalBudgetForMinMaj(this)" placeholder="₹ 0" class="form-control text-end">
                                                            <span class="error-msg col-md-12" id="year_6_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="year_field_3 non_recurring">
                                                            <input type="number" id="year_7_3" name="year_7_3" value="" min="0" oninput="validateInput(this)" onblur="convertNumberToDecimal(this)" onkeyup="calculateTotalBudgetForMinMaj(this)" placeholder="₹ 0" class="form-control text-end">
                                                            <span class="error-msg col-md-12" id="year_7_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="books_journals_row">
                                                        ...
                                                        <td class="year_field_3 non_recurring">
                                                            <input type="number" id="year_8_3" name="year_8_3" value="" min="0" oninput="validateInput(this)" onblur="convertNumberToDecimal(this)" onkeyup="calculateTotalBudgetForMinMaj(this)" placeholder="₹ 0" class="form-control text-end">
                                                            <span class="error-msg col-md-12" id="year_8_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="table-light" style="border: inherit;">
                                                        ...
                                                        <td class="year_field_3 non_recurring">
                                                            <input type="number" id="year_9_3" name="year_9_3" value="" min="0" oninput="validateInput(this)" placeholder="₹ 0" class="form-control text-end" readonly>
                                                            <span class="error-msg col-md-12" id="year_9_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="year_field_3">
                                                            <input type="number" id="year_10_3" name="year_10_3" value="" min="0" oninput="validateInput(this)" onblur="convertNumberToDecimal(this)" onkeyup="calculateTotalBudgetForMinMaj(this)" placeholder="₹ 0" class="form-control text-end">
                                                            <span class="error-msg col-md-12" id="year_10_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="year_field_3">
                                                            <input type="number" id="year_11_3" name="year_11_3" value="" min="0" oninput="validateInput(this)" onblur="convertNumberToDecimal(this)" onkeyup="calculateTotalBudgetForMinMaj(this)" placeholder="₹ 0" class="form-control text-end">
                                                            <span class="error-msg col-md-12" id="year_11_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="year_field_3">
                                                            <input type="number" id="year_12_3" name="year_12_3" value="" min="0" oninput="validateInput(this)" onblur="convertNumberToDecimal(this)" onkeyup="calculateTotalBudgetForMinMaj(this)" placeholder="₹ 0" class="form-control text-end">
                                                            <span class="error-msg col-md-12" id="year_12_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="year_field_3">
                                                            <input type="number" id="year_13_3" name="year_13_3" value="" min="0" oninput="validateInput(this)" onblur="convertNumberToDecimal(this)" onkeyup="calculateTotalBudgetForMinMaj(this)" placeholder="₹ 0" class="form-control text-end">
                                                            <span class="error-msg col-md-12" id="year_13_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="year_field_3">
                                                            <input type="number" id="year_14_3" name="year_14_3" value="" min="0" oninput="validateInput(this)" onblur="convertNumberToDecimal(this)" onkeyup="calculateTotalBudgetForMinMaj(this)" placeholder="₹ 0" class="form-control text-end">
                                                            <span class="error-msg col-md-12" id="year_14_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="text-center budget_row_count">8</td>
                                                        <td>Special Needs (if any) </td>
                                                        <td class="year_field_1">
                                                            <input type="number" id="year_15_1" name="year_15_1" value="" min="0" oninput="validateInput(this)" onblur="convertNumberToDecimal(this)" onkeyup="calculateTotalBudgetForMinMaj(this)" placeholder="₹ 0" class="form-control text-end">
                                                            <span class="error-msg col-md-12" id="year_15_1_error_msg"></span>
                                                        </td>
                                                        <td class="year_field_2">
                                                            <input type="number" id="year_15_2" name="year_15_2" value="" min="0" oninput="validateInput(this)" onblur="convertNumberToDecimal(this)" onkeyup="calculateTotalBudgetForMinMaj(this)" placeholder="₹ 0" class="form-control text-end">
                                                            <span class="error-msg col-md-12" id="year_15_2_error_msg"></span>
                                                        </td>
                                                        <td class="year_field_3">
                                                            <input type="number" id="year_15_3" name="year_15_3" value="" min="0" oninput="validateInput(this)" onblur="convertNumberToDecimal(this)" onkeyup="calculateTotalBudgetForMinMaj(this)" placeholder="₹ 0" class="form-control text-end">
                                                            <span class="error-msg col-md-12" id="year_15_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="table-light" style="border: inherit;">
                                                        ...
                                                        <td class="year_field_3">
                                                            <input type="number" id="year_16_3" name="year_16_3" value="" min="0" oninput="validateInput(this)" placeholder="₹ 0" class="form-control text-end" readonly>
                                                            <span class="error-msg col-md-12" id="year_16_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="table-light" style="border: inherit;">
                                                        ...
                                                        <td>Grand TOTAL</td>
                                                        <td class="year_field_1">
                                                            <input type="number" id="year_17_1" name="year_17_1" value="" min="0" oninput="validateInput(this)" placeholder="₹ 0" class="form-control text-end" readonly>
                                                            <span class="error-msg col-md-12" id="year_17_1_error_msg"></span>
                                                        </td>
                                                        <td class="year_field_2">
                                                            <input type="number" id="year_17_2" name="year_17_2" value="" min="0" oninput="validateInput(this)" placeholder="₹ 0" class="form-control text-end" readonly>
                                                            <span class="error-msg col-md-12" id="year_17_2_error_msg"></span>
                                                        </td>
                                                        <td class="year_field_3">
                                                            <input type="number" id="year_17_3" name="year_17_3" value="" min="0" oninput="validateInput(this)" placeholder="₹ 0" class="form-control text-end" readonly>
                                                            <span class="error-msg col-md-12" id="year_17_3_error_msg"></span>
                                                        </td>
                                                        <td>
                                                            <input type="number" id="year_17_total" name="year_17_total" value="" oninput="validateInput(this)" placeholder="₹ 0" class="form-control text-end" readonly>
                                                            <span class="error-msg col-md-12" id="year_17_total_error_msg"></span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <label for="budget_components_details" class="form-label"> Please justify each of the budget components by specifying the serial number given in the table</label>
                                            ...
                                            <div class="input_fields_wrap_budget_components_details">
                                                <div class="row wrapper_row mb-4">
                                                    <div class="col-md-1 serial-number text-center content-center text-center-vertical">1</div>
                                                    <div class="col-md-10">
                                                        <div class="row">
                                ...
                                <div class="forms">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-lg-6 mb-5" id="file_aadhar_card_field">
                                            <label for="file_aadhar_card" class="form-label star">Aadhar Card from PI<span>(Self Attested)</label>
                                            <p>Attach a scanned PDF copy of max 700KB <?php include "layout/tooltip-i.php"; ?> </p>
                                            <div class="form-check" style="padding-left: 0;">
                                        ...
                                        <div class="col-md-12 col-lg-6 mb-5" id="file_principal_endorsement_certificate_field">
                                        ...
                                        <div class="col-md-12 col-lg-6 mb-5" id="file_phd_certificate_field">
                                            <label for="file_phd_certificate" class="form-label star">PhD Certificates(Self attested)</label>
                                            <p>Attach a scanned PDF copy of max 700KB <?php include "layout/tooltip-i.php"; ?> </p>
                                            <div class="form-check col-lg-9" style="padding-left: 0;">
                                                <input type="file" id="file_phd_certificate" name="file_phd_certificate" placeholder="" class="form-control input-md" accept="application/pdf">
                                                <?php showProgressBar('docs','file_phd_certificate', ''); ?>
                                            </div>
                                        </div>
                                        
                                        <div class="col-md-12 col-lg-6 mb-5" id="file_pi_cv_field">
                                            <label for="file_pi_cv" class="form-label star">Please upload CV of PI </label>
                                            <p>Attach a scanned PDF copy of max 700KB <?php include "layout/tooltip-i.php"; ?> </p>
                                            <div class="form-check" style="padding-left: 0;">
                                        ...
                                        <div class="col-md-12 col-lg-6 mb-5" id="file_co_pi_cv_field">
                                            <label for="file_co_pi_cv" class="form-label">Please upload CV of Co-PIs <br> (Merge the CV in case more than 1 Co-PIs)</label>
                                            <p>Attach a scanned PDF copy of max 700KB <?php include "layout/tooltip-i.php"; ?> </p>
                                            <div class="form-check" style="padding-left: 0;">
                                                <input type="file" id="file_co_pi_cv" name="file_co_pi_cv" placeholder="" class="form-control input-md" accept="application/pdf">
                                                <?php showProgressBar('docs','file_co_pi_cv', ''); ?>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    let first_name=middle_name=last_name=dob=country_code=phone_no=email=designation=qualification=official_address=department=specialisation=file_profile_picture=
        co_inv_i_first_name=co_inv_i_middle_name=co_inv_i_last_name=co_inv_i_dob=co_inv_i_country_code=co_inv_i_phone_no=co_inv_i_email=co_inv_i_designation=co_inv_i_qualification=co_inv_i_official_address=co_inv_i_department=co_inv_i_specialisation=
        co_inv_ii_first_name=co_inv_ii_middle_name=co_inv_ii_last_name=co_inv_ii_dob=co_inv_ii_country_code=co_inv_ii_phone_no=co_inv_ii_email=co_inv_ii_designation=co_inv_ii_qualification=co_inv_ii_official_address=co_inv_ii_department=co_inv_ii_specialisation=
        proposed_amount='';
    ...
    let invest_names = document.getElementsByName("invest_name[]");
    let invest_roles = document.getElementsByName("invest_role[]");
    ...
    let budget_consolidated =budget_project_relevance=
        year_1_1 = year_1_2 = year_1_3 = year_1_total = 
        year_2_1 = year_2_2 = year_2_3 = year_2_total = 
        year_3_1 = year_3_2 = year_3_3 = year_3_total = equipment_a = 
        year_4_1 = year_4_2 = year_4_3 = year_4_total = equipment_b =  
        year_5_1 = year_5_2 = year_5_3 = year_5_total = equipment_c =  
        year_6_1 = year_6_2 = year_6_3 = year_6_total = equipment_d =  
        year_7_1 = year_7_2 = year_7_3 = year_7_total = equipment_e =   
        year_8_1 = year_8_2 = year_8_3 = year_8_total = 
        year_9_1 = year_9_2 = year_9_3 = year_9_total = 
        year_10_1 = year_10_2 = year_10_3 = year_10_total = 
        year_11_1 = year_11_2 = year_11_3 = year_11_total = 
        year_12_1 = year_12_2 = year_12_3 = year_12_total = 
        year_13_1 = year_13_2 = year_13_3 = year_13_total = 
        year_14_1 = year_14_2 = year_14_3 = year_14_total = 
        year_15_1 = year_15_2 = year_15_3 = year_15_total = 
        year_16_1 = year_16_2 = year_16_3 = year_16_total =
        year_17_1 = year_17_2 = year_17_3 = year_17_total = '';
    ...
    let is_pi_belong_to_category=is_pi_differently_abled=0;
    ...
    const fileInputPhdCertificate = document.getElementById('file_phd_certificate');
    const fileInputPICv = document.getElementById('file_pi_cv');
    const fileInputCoPICv = document.getElementById('file_co_pi_cv');
	...
	// let x = 1;
	let max_fields_bibliography = 
        max_fields_budgetComponentsDetails = 20,
        max_fields_instituteDetails = 
        max_fields_investExpertise = 
        max_fields_investPublication = 
	...
	var wrapper_investExpertise = $(".input_fields_wrap_invest_expertise > tbody");     // Fields wrapper
	let add_button_investExpertise = $(".add_field_button_invest_expertise"); 	// Add button ID
    ...
    $(document).ready(function() {
        ...
        document.getElementById('co_inv_i_dob').max = today;
        document.getElementById('co_inv_ii_dob').max = today;
        // document.getElementById('investigators_ongoing_project_start_date_1').max = today;
        // document.getElementById('investigators_ongoing_project_end_date_1').max = today;
        // document.getElementById('investigators_completed_project_start_date_1').max = today;
        // document.getElementById('investigators_completed_project_end_date_1').max = today;
        
        // Hide some fields updated on 06/07/2024 -- preset content to hidden
        // $(".year_field_2").hide(); 
        ...
        saveData = getSavedData = JSON.parse(localStorage.getItem("majorResearchProjectData"));
        if (getSavedData && getSavedData['id']) {
            ...
            $("#department").val(getSavedData["investigator_details"][0]['department']);
            $("#specialisation").val(getSavedData["investigator_details"][0]['specialisation']);
            ...
            $("#co_inv_i_first_name").val(getSavedData["investigator_details"][1]['first_name']);
                $("#co_inv_i_middle_name").val(getSavedData["investigator_details"][1]['middle_name']);
                $("#co_inv_i_last_name").val(getSavedData["investigator_details"][1]['last_name']);
                if (getSavedData["investigator_details"][1]['gender']) {
                    co_inv_i_gender = getSavedData["investigator_details"][1]['gender'];
                }
                $("input:radio[name=co_inv_i_gender]").val([co_inv_i_gender]);
                $("#co_inv_i_dob").val(getSavedData["investigator_details"][1]['dob']);
                $("#co_inv_i_country_code").val(getSavedData["investigator_details"][1]['country_code']);
                $("#co_inv_i_phone_no").val(getSavedData["investigator_details"][1]['phone_no']);
                $("#co_inv_i_email").val(getSavedData["investigator_details"][1]['email']);
                $("#co_inv_i_designation").val(getSavedData["investigator_details"][1]['designation']);
                $("#co_inv_i_qualification").val(getSavedData["investigator_details"][1]['qualification']);
                $("#co_inv_i_official_address").val(getSavedData["investigator_details"][1]['official_address']);
                $("#co_inv_i_department").val(getSavedData["investigator_details"][1]['department']);
                $("#co_inv_i_specialisation").val(getSavedData["investigator_details"][1]['specialisation']);

            $("#co_inv_ii_first_name").val(getSavedData["investigator_details"][2]['first_name']);
                $("#co_inv_ii_middle_name").val(getSavedData["investigator_details"][2]["middle_name"]);
                $("#co_inv_ii_last_name").val(getSavedData["investigator_details"][2]["last_name"]);
                if (getSavedData["investigator_details"][2]["gender"]) {
                    co_inv_ii_gender = getSavedData["investigator_details"][2]["gender"];
                }
                $("input:radio[name=co_inv_ii_gender]").val([co_inv_ii_gender]);
                $("#co_inv_ii_dob").val(getSavedData["investigator_details"][2]["dob"]);
                $("#co_inv_ii_country_code").val(getSavedData["investigator_details"][2]["country_code"]);
                $("#co_inv_ii_phone_no").val(getSavedData["investigator_details"][2]["phone_no"]);
                $("#co_inv_ii_email").val(getSavedData["investigator_details"][2]["email"]);
                $("#co_inv_ii_designation").val(getSavedData["investigator_details"][2]["designation"]);
                $("#co_inv_ii_qualification").val(getSavedData["investigator_details"][2]["qualification"]);
                $("#co_inv_ii_official_address").val(getSavedData["investigator_details"][2]["official_address"]);
                $("#co_inv_ii_department").val(getSavedData["investigator_details"][2]['department']);
            $("#co_inv_ii_specialisation").val(getSavedData["investigator_details"][2]['specialisation']);
            ...
            let investigatorRoleDetails = getSavedData["investigator_role_details"];
            if ( !investigatorRoleDetails || investigatorRoleDetails == "null" ) {} else {
                x_investExpertise = 0
                investigatorRoleDetails.forEach(investigatorRoleDetail => {
                    if(x_investExpertise < max_fields_investExpertise){ 					//max input box allowed
                        x_investExpertise++; 								//text box increment
                        if (x_investExpertise==1) {
                            $("#invest_name_1").val(investigatorRoleDetail['name']);
                            $("#invest_role_1").val(investigatorRoleDetail['role']);
                        } else {
                            $(wrapper_investExpertise).append(`
                                <tr class="wrapper_row">
                                    <td class="serial-number text-center">`+x_investExpertise+`</td>
                                    <td>
                                        <input type="text" class="form-control" name="invest_name[]" id="invest_name_`+x_investExpertise+`" value="${investigatorRoleDetail['name']}" oninput="validateInput(this)" placeholder="Enter full name" aria-describedby="">
                                        <span class="error-msg " id="invest_name_`+x_investExpertise+`_error_msg"></span>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="invest_role[]" id="invest_role_`+x_investExpertise+`" value="${investigatorRoleDetail['role']}" oninput="validateInput(this)" placeholder="Enter role" aria-describedby="">
                                        <span class="error-msg " id="invest_role_`+x_investExpertise+`_error_msg"></span>
                                    </td>
                                    <td width="62px">
                                        <a href="#" class="remove_field text-center"><i class="bi bi-trash custom_btn btn2"></i></a>
                                    </td>
                            ...
                            `); //add input box
                            if (x_investExpertise == max_fields_investExpertise) {
                                $(".add_field_button_invest_expertise").attr("disabled", true);
                            }
                        }
                    }
                });
                        ...
                        if (x_projectDetailsSubmitted==1) {
                            ...
                            $(wrapper_projectDetailsSubmitted).append(`
                                <tr class="wrapper_row">
                                    ...
                                    <td>
                                        <input type="number" class="form-control" name="investigators_project_cost[]" id="investigators_project_cost_`+x_projectDetailsSubmitted+`" value="${investigatorsSubmittedProject['cost_in_lakhs']}" min="0" oninput="validateInput(this)" placeholder="₹" aria-describedby="0000">
                                        <span class="error-msg col-md-12" id="investigators_project_cost_`+x_projectDetailsSubmitted+`_error_msg"></span>
                                    </td>
                                    <td>
                                        <input type="month" class="form-control" name="investigators_project_submission_month[]" id="investigators_project_submission_month_`+x_projectDetailsSubmitted+`" value="${investigatorsSubmittedProject['submission_month']}" oninput="validateInput(this)" placeholder="Month" aria-describedby="Submission month">
                        ...
                        if (x_projectDetailsOngoing==1) {
                            ...
                            $(wrapper_projectDetailsOngoing).append(`
                                <tr class="wrapper_row">
                                    ...
                                    <td>
                                        <input type="number" class="form-control" name="investigators_ongoing_project_cost[]" id="investigators_ongoing_project_cost_`+x_projectDetailsOngoing+`" value="${investigatorsOngoingProject['cost_in_lakhs']}" min="0" oninput="validateInput(this)" placeholder="₹" aria-describedby="0000">
                        ...
                        if (x_projectDetailsCompleted==1) {
                            ...
                            $(wrapper_projectDetailsCompleted).append(`
                                <tr class="wrapper_row">
                                    ...
                                    <td>
                                        <input type="number" class="form-control" name="investigators_completed_project_cost[]" id="investigators_completed_project_cost_`+x_projectDetailsCompleted+`" value="${investigatorsCompletedProject['cost_in_lakhs']}" min="0" oninput="validateInput(this)" placeholder="₹" aria-describedby="0000">
                    ...
                    if(x_facilityDetailsEquipment < max_fields_facilityDetailsEquipment){ 					//max input box allowed
                        ...
                        if (x_facilityDetailsEquipment==1) {
                            ...
                            $(wrapper_facilityDetailsEquipment).append(`
                                <tr class="wrapper_row">
                                    <td>
                                        <input type="text" name="equipment_institute[]" id="equipment_institute_`+x_facilityDetailsEquipment+`" value="${equipmentDetails['available_with']}" oninput="validateInput(this)" placeholder="Enter other institute" class="form-control">
                                        <span class="error-msg col-md-12" id="equipment_institute_`+x_facilityDetailsEquipment+`_error_msg"></span>
                                    </td>
                                    <td>
                                        <textarea class="form-control" name="equipment_name[]" id="equipment_name_`+x_facilityDetailsEquipment+`" value="${equipmentDetails['generic_name']}" oninput="validateInput(this)" onkeyup="checkInputToNull('`+x_facilityDetailsEquipment+`',this,'equipment_name')" cols="80" rows="2" placeholder=""></textarea>
                                        <span class="error-msg col-md-12" id="equipment_name_`+x_facilityDetailsEquipment+`_error_msg"></span>
                                    </td>
                                    <td>
                                        <textarea class="form-control" name="equipment_model[]" id="equipment_model_`+x_facilityDetailsEquipment+`" value="${equipmentDetails['purchase_details']}" oninput="validateInput(this)" cols="80" rows="2" placeholder=""></textarea>
                                        <span class="error-msg col-md-12" id="equipment_model_`+x_facilityDetailsEquipment+`_error_msg"></span>
                                    </td>
                                    <td>
                                        <textarea class="form-control" name="equipment_remark[]" id="equipment_remark_`+x_facilityDetailsEquipment+`" value="${equipmentDetails['remarks_on_accessories']}" oninput="validateInput(this)" cols="80" rows="2" placeholder=""></textarea>
                    ...
                    if(x_expertOrInstitution < max_fields_expertOrInstitution){ 					//max input box allowed
                        ...
                        if (x_expertOrInstitution==1) {
                            ...
                            $(wrapper_expertOrInstitution).append(`
                                <div class="row wrapper_row">
                                    <div class="col-md-1 serial-number text-center content-center text-center-vertical">`+x_expertOrInstitution+`</div>
                                    <div class="col-md-10">
                                        <div class="row">
                                            <div class="form-group col-md-4 mb-4">
                                                <label class="form-label star fw6" for="guide_name_`+x_expertOrInstitution+`">Name</label>  
                                            ...
                                            <div class="form-group col-md-8 mb-4">
                                                <label class="form-label star fw6" for="guide_address_`+x_expertOrInstitution+`">Address</label>  
                                                <textarea class="form-control" name="guide_address[]" id="guide_address_`+x_expertOrInstitution+`" oninput="validateInput(this)" cols="80" rows="1" placeholder="Enter address">${outcomeInterestedExpertDetail['address']}</textarea>
            ...
            for (let index = 1; index <= 17; index++) {
                ...
                $("#year_"+index+"_3").val(getSavedData["year_"+index+"_3"]);
            ...
            // }
            if (getSavedData["file_phd_certificate"]) {
                file_phd_certificate = getSavedData["file_phd_certificate"];
                displayUploadedFile('docs', 'file_phd_certificate', file_phd_certificate);
            }
            if (getSavedData["file_pi_cv"]) {
                file_pi_cv = getSavedData["file_pi_cv"];
                displayUploadedFile('docs', 'file_pi_cv', file_pi_cv);
            }
            if (getSavedData["file_co_pi_cv"]) {
                file_co_pi_cv = getSavedData["file_co_pi_cv"];
                displayUploadedFile('docs', 'file_co_pi_cv', file_co_pi_cv);
            }
        } else {
            $("#form_0").addClass('d-block'); // display tab content
            callApi({
                method: 'GET',
                url: 'api/schemeMajorResearchProjectApi.php?id='+userId+'&schemeBatchId='+schemeBatchId+'&type=preview',
        ...
        // add multiple rows 
            ...
            // Expertise Investor
            $(add_button_investExpertise).click(function(e){ 			    //on add input button click
                e.preventDefault();
                x_investExpertise = invest_names.length;
                if(x_investExpertise < max_fields_investExpertise){ 					//max input box allowed
                    x_investExpertise++;					                    //text box increment
                    $(wrapper_investExpertise).append(`
                        <tr class="wrapper_row">
                            <td class="serial-number text-center">`+x_investExpertise+`</td>
                            <td>
                                <input type="text" class="form-control" name="invest_name[]" id="invest_name_`+x_investExpertise+`" value="" oninput="validateInput(this)" placeholder="Enter full name" aria-describedby="">
                                <span class="error-msg " id="invest_name_`+x_investExpertise+`_error_msg"></span>
                            </td>
                            <td>
                                <input type="text" class="form-control" name="invest_role[]" id="invest_role_`+x_investExpertise+`" value="" oninput="validateInput(this)" placeholder="Enter role" aria-describedby="">
                                <span class="error-msg " id="invest_role_`+x_investExpertise+`_error_msg"></span>
                            </td>
                            <td width="62px">
                                <a href="#" class="remove_field text-center"><i class="bi bi-trash custom_btn btn2"></i></a>
            ...
            $(wrapper_investExpertise).on("click",".remove_field", function(e){
                e.preventDefault(); 
                $(this).closest('tr').remove();
                x_investExpertise--;
                if (x_investExpertise < max_fields_investExpertise) {
                    $(".add_field_button_invest_expertise").attr("disabled", false);
                }
                updateSerialNumbers(wrapper_investExpertise);
            }); // click on remove fields
                ...
                if(x_projectDetailsSubmitted < max_fields_projectDetailsSubmitted){ 					//max input box allowed
                    ...
                    $(wrapper_projectDetailsSubmitted).append(`
                        <tr class="wrapper_row">
                            ...
                            <td>
                                <input type="number" class="form-control" name="investigators_project_cost[]" id="investigators_project_cost_`+x_projectDetailsSubmitted+`" value="" min="0" oninput="validateInput(this)" placeholder="₹" aria-describedby="0000">
                                <span class="error-msg col-md-12" id="investigators_project_cost_`+x_projectDetailsSubmitted+`_error_msg"></span>
                            </td>
                            <td>
                                <input type="month" class="form-control" name="investigators_project_submission_month[]" id="investigators_project_submission_month_`+x_projectDetailsSubmitted+`" value="" oninput="validateInput(this)" placeholder="Month" aria-describedby="Submission month">
                                <span class="error-msg col-md-12" id="investigators_project_submission_month_`+x_projectDetailsSubmitted+`_error_msg"></span>
                            </td>
                            <td>
                ...
                if(x_projectDetailsOngoing < max_fields_projectDetailsOngoing){ 					//max input box allowed
                    ...
                    $(wrapper_projectDetailsOngoing).append(`
                        <tr class="wrapper_row">
                            ...
                            <td>
                                <input type="number" class="form-control" name="investigators_ongoing_project_cost[]" id="investigators_ongoing_project_cost_`+x_projectDetailsOngoing+`" value="" min="0" oninput="validateInput(this)" placeholder="₹" aria-describedby="0000">
                                <span class="error-msg col-md-12" id="investigators_ongoing_project_cost_`+x_projectDetailsOngoing+`_error_msg"></span>
                            </td>
                            <td>
            ...
            $(add_button_facilityDetailsEquipment).click(function(e){ 			    //on add input button click
                ...
                if(x_facilityDetailsEquipment < max_fields_facilityDetailsEquipment){ 					//max input box allowed
                    ...
                    $(wrapper_facilityDetailsEquipment).append(`
                        <tr class="wrapper_row">
                            <td>
                                <input type="text" name="equipment_institute[]" id="equipment_institute_`+x_facilityDetailsEquipment+`" value="" oninput="validateInput(this)" placeholder="Institute" class="form-control">
                                <span class="error-msg col-md-12" id="equipment_institute_`+x_facilityDetailsEquipment+`_error_msg"></span>
                            </td>
                            <td>
                        ...
                        <div class="row wrapper_row">
                            ...
                            <div class="col-md-10">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8 mb-4">
                                        <label class="form-label star fw6" for="guide_address_`+x_expertOrInstitution+`">Address</label>  
                                        <textarea class="form-control" name="guide_address[]" id="guide_address_`+x_expertOrInstitution+`" oninput="validateInput(this)" cols="80" rows="1" placeholder="Enter address"></textarea>
                                        <span class="error-msg col-md-12" id="guide_address_`+x_expertOrInstitution+`_error_msg"></span>
                                    </div>
                                </div>
                            </div>
    ...
    // upload images --------------------------------
        ...
        // fileInputRegistrarEndorseCertificate.addEventListener('change', async (event) => {
            ...
            // 	}
            // });
        fileInputPhdCertificate.addEventListener('change', async (event) => {
            const file = event.target.files[0];
            if (file) {
                const encodedFile = await encodeFile(file);
                let fileData = {
                ...
                uploadFile({
                    'file_type' : 'docs', 
                    'response_id' : 'file_phd_certificate', 
                    'file_id' : fileInputPhdCertificate, 
                    'file_data' : fileData, 
                    'storage_key' : 'majorResearchProjectData'
                });
                isSavedForm_9 = false;
        ...
        fileInputCoPICv.addEventListener('change', async (event) => {
            const file = event.target.files[0];
            if (file) {
                const encodedFile = await encodeFile(file);
                let fileData = {
                ...
                uploadFile({
                    'file_type' : 'docs', 
                    'response_id' : 'file_co_pi_cv', 
                    'file_id' : fileInputCoPICv, 
                    'file_data' : fileData, 
                    'storage_key' : 'majorResearchProjectData'
                });
                isSavedForm_9 = false;
    ...
    function saveForm(formNo) {
        if (formNo==0) {
            ...
            saveData["investigator_details"].push({
                        ...
                        'department' : validateEmptyFields("department", ""),
                        'specialisation' : validateEmptyFields("specialisation", ""),
                    });
            saveData["investigator_details"].push({
                        'type' : 'co_investigator_i',
                        'first_name' : validateEmptyFields("co_inv_i_first_name", ""),
                        'middle_name' : validateEmptyFields("co_inv_i_middle_name", ""),
                        'last_name' : validateEmptyFields("co_inv_i_last_name", ""),
                        'gender' : co_inv_i_gender,
                        'dob' : validateEmptyFields("co_inv_i_dob", ""),
                        'country_code' : validateEmptyFields("co_inv_i_country_code", ""),
                        'phone_no' : validateEmptyFields("co_inv_i_phone_no", ""),
                        'email' : validateEmptyFields("co_inv_i_email", ""),
                        'designation' : validateEmptyFields("co_inv_i_designation", ""),
                        'qualification' : validateEmptyFields("co_inv_i_qualification", ""),
                        'official_address' : validateEmptyFields("co_inv_i_official_address", ""),
                        'department' : validateEmptyFields("co_inv_i_department", ""),
                        'specialisation' : validateEmptyFields("co_inv_i_specialisation", ""),
                    });
            saveData["investigator_details"].push({
                        'type' : 'co_investigator_ii',
                        'first_name' : validateEmptyFields("co_inv_ii_first_name", ""),
                        'middle_name' : validateEmptyFields("co_inv_ii_middle_name", ""),
                        'last_name' : validateEmptyFields("co_inv_ii_last_name", ""),
                        'gender' : co_inv_ii_gender,
                        'dob' : validateEmptyFields("co_inv_ii_dob", ""),
                        'country_code' : validateEmptyFields("co_inv_ii_country_code", ""),
                        'phone_no' : validateEmptyFields("co_inv_ii_phone_no", ""),
                        'email' : validateEmptyFields("co_inv_ii_email", ""),
                        'designation' : validateEmptyFields("co_inv_ii_designation", ""),
                        'qualification' : validateEmptyFields("co_inv_ii_qualification", ""),
                        'official_address' : validateEmptyFields("co_inv_ii_official_address", ""),
                        'department' : validateEmptyFields("co_inv_ii_department", ""),
                        'specialisation' : validateEmptyFields("co_inv_ii_specialisation", ""),
                    });
            ...
            saveData["investigator_role_details"] = [];
			if (invest_names.length>0) {
				for(let j=0;j<invest_names.length;j++)
				{
					if ( invest_names[j].value == "" && invest_roles[j].value == "" ) {
						// do nothing all fields are empty
					} else {
						saveData["investigator_role_details"].push({
							'name': invest_names[j].value,
							'role': invest_roles[j].value,
						});
					}
				}
			}
            ...
            saveData["budget_project_relevance"] = validateEmptyFields("budget_project_relevance", "");
                ...
                saveData["year_1_3"] = validateEmptyFields("year_1_3", "");
                ...
                saveData["year_2_3"] = validateEmptyFields("year_2_3", "");
                ...
                saveData["year_3_3"] = validateEmptyFields("year_3_3", "");
                ...
                saveData["year_4_3"] = validateEmptyFields("year_4_3", "");
                ...
                saveData["year_5_3"] = validateEmptyFields("year_5_3", "");
                ...
                saveData["year_6_3"] = validateEmptyFields("year_6_3", "");
                ...
                saveData["year_7_3"] = validateEmptyFields("year_7_3", "");
                ...
                saveData["year_8_3"] = validateEmptyFields("year_8_3", "");
                ...
                saveData["year_9_3"] = validateEmptyFields("year_9_3", "");
                ...
                saveData["year_10_3"] = validateEmptyFields("year_10_3", "");
                ...
                saveData["year_11_3"] = validateEmptyFields("year_11_3", "");
                ...
                saveData["year_12_3"] = validateEmptyFields("year_12_3", "");
                ...
                saveData["year_13_3"] = validateEmptyFields("year_13_3", "");
                ...
                saveData["year_14_3"] = validateEmptyFields("year_14_3", "");
                ...
                saveData["year_15_3"] = validateEmptyFields("year_15_3", "");
                ...
                saveData["year_16_3"] = validateEmptyFields("year_16_3", "");
                saveData["year_16_total"] = validateEmptyFields("year_16_total", "");
                saveData["year_17_1"] = validateEmptyFields("year_17_1", "");
                saveData["year_17_2"] = validateEmptyFields("year_17_2", "");
                saveData["year_17_3"] = validateEmptyFields("year_17_3", "");
                saveData["year_17_total"] = validateEmptyFields("year_17_total", "");
            isSavedForm_8 = true;
            ...
            file_phd_certificate = saveData["file_phd_certificate"];
            file_pi_cv = saveData["file_pi_cv"];
            file_co_pi_cv = saveData["file_co_pi_cv"];
            isSavedForm_9 = true;
        }
        ...
        localStorage.setItem("majorResearchProjectData", JSON.stringify(saveData));
    ...
    function validateFormData(formNo) {
        let minCharLength = 3;
        let minCharLengthTextarea = 10;
        let msg = ' must be between '+minCharLength+' and 600 characters';
        let msg2 = ' must be between '+minCharLengthTextarea+' and 600 characters';
        ...
        if (formNo==0) {
            ...
            co_inv_ii_specialisation = validateEmptyFields("co_inv_ii_specialisation", "");
                co_inv_ii_department = validateEmptyFields("co_inv_ii_department", ""); // Please enter department
                co_inv_ii_official_address = validateEmptyFields("co_inv_ii_official_address", "");  //Please enter Co-investigators II official address
                co_inv_ii_qualification = validateEmptyFields("co_inv_ii_qualification", "");  //Please enter Co-investigators II qualification!
                co_inv_ii_designation = validateEmptyFields("co_inv_ii_designation", "");  //Please enter Co-investigators II designation
                co_inv_ii_email = validateEmailId("co_inv_ii_email", "");  //Please enter Co-investigators II EMAIL ID!
                co_inv_ii_phone_no = validatePhoneNumber("co_inv_ii_phone_no", "");  //Please enter Co-investigators II phone Number cannot be empty!
                co_inv_ii_country_code = validateEmptyFields("co_inv_ii_country_code", "");  //Please enter Country code cannot be empty!
                co_inv_ii_dob = validateEmptyFields("co_inv_ii_dob", "");  //Please enter Co-investigators II Date of Birth!
                co_inv_ii_last_name = validateEmptyFields("co_inv_ii_last_name", "");  //Please enter Principal Co-investigators II Last name!
                co_inv_ii_middle_name = validateEmptyFields("co_inv_ii_middle_name", ""); 
                co_inv_ii_first_name = validateEmptyFields("co_inv_ii_first_name", "");  //Please enter Principal Co-investigators II First name!

                co_inv_i_specialisation = validateEmptyFields("co_inv_i_specialisation", "");
                co_inv_i_department = validateEmptyFields("co_inv_i_department", ""); // Please enter department
                co_inv_i_official_address = validateEmptyFields("co_inv_i_official_address", "");  // Please enter Co-investigators I official address
                co_inv_i_qualification = validateEmptyFields("co_inv_i_qualification", "");  // Please enter Co-investigators I qualification!
                co_inv_i_designation = validateEmptyFields("co_inv_i_designation", "");  // Please enter Co-investigators I designation
                co_inv_i_email = validateEmailId("co_inv_i_email", "");  // Please enter Co-investigators I EMAIL ID!
                co_inv_i_phone_no = validatePhoneNumber("co_inv_i_phone_no", "");  // Please enter Co-investigators I phone Number cannot be empty!
                co_inv_i_country_code = validateEmptyFields("co_inv_i_country_code", "");  // Please enter Please enterCountry code cannot be empty!
                co_inv_i_dob = validateEmptyFields("co_inv_i_dob", "");  // Please enter Co-investigators I Date of Birth!
                co_inv_i_last_name = validateEmptyFields("co_inv_i_last_name", "");  // Please enter Principal Co-investigators I Last name!
                co_inv_i_middle_name = validateEmptyFields("co_inv_i_middle_name", "");
                co_inv_i_first_name = validateEmptyFields("co_inv_i_first_name", "");  // Please enter Principal Co-investigators I First name!

                specialisation = validateEmptyFields("specialisation", "");
                department = validateEmptyFields("department", "Please enter department");
            ...
            if (proposed_amount && file_profile_picture && 
                department && official_address && qualification && designation && email && phone_no && country_code && dob && gender && last_name && first_name
            ) { 
                ...
                if (co_inv_i_specialisation) { co_inv_i_specialisation = validateEmptyFields("co_inv_i_specialisation", "Please enter valid specialisation details!"); if (!co_inv_i_specialisation) { return false; } }
                if (co_inv_i_department) { co_inv_i_department = validateEmptyFields("co_inv_i_department", "Please enter valid department details!"); if (!co_inv_i_department) { return false; } }
                if (co_inv_i_official_address) {co_inv_i_official_address = validateEmptyFields("co_inv_i_official_address", "Please enter Co-Investigator I official address"); if (!co_inv_i_official_address) { return false; } }
                if (co_inv_i_qualification) {co_inv_i_qualification = validateEmptyFields("co_inv_i_qualification", "Please enter Co-Investigator I qualification!"); if (!co_inv_i_qualification) { return false; } }
                if (co_inv_i_designation) {co_inv_i_designation = validateEmptyFields("co_inv_i_designation", "Please enter Co-Investigator I designation"); if (!co_inv_i_designation) { return false; } }
                if (co_inv_i_email) {co_inv_i_email = validateEmptyFields("co_inv_i_email", "Please enter Co-Investigator I EMAIL ID!"); if (!co_inv_i_email) { return false; } }
                if (co_inv_i_phone_no) {co_inv_i_phone_no = validateEmptyFields("co_inv_i_phone_no", "Co-Investigator I phone Number cannot be empty!"); if (!co_inv_i_phone_no) { return false; } }
                if (co_inv_i_country_code) {co_inv_i_country_code = validateEmptyFields("co_inv_i_country_code", "Country code cannot be empty!"); if (!co_inv_i_country_code) { return false; } }
                if (co_inv_i_dob) {co_inv_i_dob = validateEmptyFields("co_inv_i_dob", "Please enter Co-Investigator I Date of Birth!"); if (!co_inv_i_dob) { return false; } }
                if (co_inv_i_last_name) {co_inv_i_last_name = validateEmptyFields("co_inv_i_last_name", "Please enter Principal Co-Investigator I Last name!"); if (!co_inv_i_last_name) { return false; } }
                if (co_inv_i_middle_name) {co_inv_i_middle_name = validateEmptyFields("co_inv_i_middle_name", "Please enter Co-Investigator I middle name"); if (!co_inv_i_middle_name) { return false; } }
                if (co_inv_i_first_name) {co_inv_i_first_name = validateEmptyFields("co_inv_i_first_name", "Please enter Principal Co-Investigator I First name!"); if (!co_inv_i_first_name) { return false; } }
                
                if (co_inv_ii_specialisation) { co_inv_ii_specialisation = validateEmptyFields("co_inv_ii_specialisation", "Please enter valid specialisation details!"); if (!co_inv_ii_specialisation) { return false; } }
                if (co_inv_ii_department) { co_inv_ii_department = validateEmptyFields("co_inv_ii_department", "Please enter valid department details!"); if (!co_inv_ii_department) { return false; } }
                if (co_inv_ii_official_address) {co_inv_ii_official_address = validateEmptyFields("co_inv_ii_official_address", "Please enter Co-Investigator II official address"); if (!co_inv_ii_official_address) { return false; } }
                if (co_inv_ii_qualification) {co_inv_ii_qualification = validateEmptyFields("co_inv_ii_qualification", "Please enter Co-Investigator II qualification!"); if (!co_inv_ii_qualification) { return false; } }
                if (co_inv_ii_designation) {co_inv_ii_designation = validateEmptyFields("co_inv_ii_designation", "Please enter Co-Investigator II designation"); if (!co_inv_ii_designation) { return false; } }
                if (co_inv_ii_email) {co_inv_ii_email = validateEmptyFields("co_inv_ii_email", "Please enter Co-Investigator II EMAIL ID!"); if (!co_inv_ii_email) { return false; } }
                if (co_inv_ii_phone_no) {co_inv_ii_phone_no = validateEmptyFields("co_inv_ii_phone_no", "Co-Investigator II phone Number cannot be empty!"); if (!co_inv_ii_phone_no) { return false; } }
                if (co_inv_ii_country_code) {co_inv_ii_country_code = validateEmptyFields("co_inv_ii_country_code", "Country code cannot be empty!"); if (!co_inv_ii_country_code) { return false; } }
                if (co_inv_ii_dob) {co_inv_ii_dob = validateEmptyFields("co_inv_ii_dob", "Please enter Co-Investigator II Date of Birth!"); if (!co_inv_ii_dob) { return false; } }
                if (co_inv_ii_last_name) {co_inv_ii_last_name = validateEmptyFields("co_inv_ii_last_name", "Please enter Principal Co-Investigator II Last name!"); if (!co_inv_ii_last_name) { return false; } }
                if (co_inv_ii_middle_name) {co_inv_ii_middle_name = validateEmptyFields("co_inv_ii_middle_name", "Please enter Co-Investigator II middle name"); if (!co_inv_ii_middle_name) { return false; } }
                if (co_inv_ii_first_name) {co_inv_ii_first_name = validateEmptyFields("co_inv_ii_first_name", "Please enter Principal Co-Investigator II First name!"); if (!co_inv_ii_first_name) { return false; } }
            ...
            if ( specific_expertise_of_pi ) {
                ...
                if (invest_names.length>0) {
                    ...
                    {
                        tempIdKey = j+1;
                        if ( validateEmptyFields("invest_name_"+tempIdKey, "Please enter the name of investigator!") ) { } else { return false; }
                        if ( validateEmptyFields("invest_role_"+tempIdKey, "Please enter the Role of investigator!") ) { } else { return false; }
                    }
                }
                if (investigator_publications.length>0) {
                    for(let j=0;j<investigator_publications.length;j++)
            ...
            if (projects_impl_infra_facilities.length>0) {
				for(let j=0;j<projects_impl_infra_facilities.length;j++)
				{
                    ...
                    if (temp_empty_val=="") {
                        ...
                        $("#projects_impl_infra_facility_"+tempIdKey).val(temp_empty_val);
                    } else {
            ...
            if (expert_guide_names.length>0) {
                ...
                if (expert_guide_names.length<3) {
                    popUpMsg('Provide names of at least 3 experts and/or institutions!'); return false;
                }
			}
            ...
            equipment_e = validateEmptyFields("equipment_e", "");
                ...
                year_10_3 = validateEmptyFields("year_10_3", "");
                ...
                year_11_3 = validateEmptyFields("year_11_3", "");
                ...
                year_12_3 = validateEmptyFields("year_12_3", "");
                ...
                year_13_3 = validateEmptyFields("year_13_3", "");
                ...
                year_14_3 = validateEmptyFields("year_14_3", "");
                ...
                year_15_3 = validateEmptyFields("year_15_3", "");
                ...
                year_16_3 = validateEmptyFields("year_16_3", "");
                year_16_total = validateEmptyFields("year_16_total", "");
                year_17_1 = validateEmptyFields("year_17_1", "");
                year_17_2 = validateEmptyFields("year_17_2", "");
                year_17_3 = validateEmptyFields("year_17_3", "");
            year_17_total = validateEmptyFields("year_17_total", "");
            ...
            if (saveData['file_co_pi_cv']) {
                file_co_pi_cv = saveData["file_co_pi_cv"];
            }
            if (saveData['file_pi_cv']) {
                file_pi_cv = saveData["file_pi_cv"];
            }
            if (saveData['file_phd_certificate']) {
                file_phd_certificate = saveData["file_phd_certificate"];
            }
            ...
            // && file_registrar_endorsement_certificate && file_co_pi_cv 
            if ( file_pi_certification && file_aadhar_card && file_principal_endorsement_certificate && file_phd_certificate && file_pi_cv  ) {
                ...
                // if (!file_co_pi_cv || file_co_pi_cv==""){ popUpMsg('Please upload the scanned copy of Co-PIs CV.'); }
                ...
                if (!file_phd_certificate || file_phd_certificate==""){ popUpMsg('Please upload the scanned copy of PhD Certificate (Self Attested).'); }
                if (!file_principal_endorsement_certificate || file_principal_endorsement_certificate==""){ popUpMsg('Please upload the scanned copy of endorsement certificate from Principal/Registrar/Head of the Institution.'); }
    ...
    function validateSavedData(formNo) {
        if (formNo==0) {
            ...
            if (proposed_amount==getSavedData["proposed_amount"] && 
                ...
                co_inv_ii_specialisation==getSavedData["investigator_details"][2].specialisation && 
                co_inv_ii_department==getSavedData["investigator_details"][2].department && 
                co_inv_ii_official_address==getSavedData["investigator_details"][2].official_address &&
                co_inv_ii_qualification==getSavedData["investigator_details"][2].qualification && 
                co_inv_ii_designation==getSavedData["investigator_details"][2].designation && 
                co_inv_ii_email==getSavedData["investigator_details"][2].email && 
                co_inv_ii_phone_no==getSavedData["investigator_details"][2].phone_no && 
                co_inv_ii_country_code==getSavedData["investigator_details"][2].country_code && 
                co_inv_ii_dob==getSavedData["investigator_details"][2].dob && 
                co_inv_ii_gender==getSavedData["investigator_details"][2].gender && 
                co_inv_ii_last_name==getSavedData["investigator_details"][2].last_name && 
                co_inv_ii_middle_name==getSavedData["investigator_details"][2].middle_name && 
                co_inv_ii_first_name==getSavedData["investigator_details"][2].first_name &&
                co_inv_i_specialisation==getSavedData["investigator_details"][1].specialisation && 
                co_inv_i_department==getSavedData["investigator_details"][1].department && 
                co_inv_i_official_address==getSavedData["investigator_details"][1].official_address && 
                co_inv_i_qualification==getSavedData["investigator_details"][1].qualification && 
                co_inv_i_designation==getSavedData["investigator_details"][1].designation && 
                co_inv_i_email==getSavedData["investigator_details"][1].email && 
                co_inv_i_phone_no==getSavedData["investigator_details"][1].phone_no && 
                co_inv_i_country_code==getSavedData["investigator_details"][1].country_code && 
                co_inv_i_dob==getSavedData["investigator_details"][1].dob && 
                co_inv_i_gender==getSavedData["investigator_details"][1].gender && 
                co_inv_i_last_name==getSavedData["investigator_details"][1].last_name && 
                co_inv_i_middle_name==getSavedData["investigator_details"][1].middle_name && 
                co_inv_i_first_name==getSavedData["investigator_details"][1].first_name && 
                specialisation==getSavedData["investigator_details"][0].specialisation && 
                department==getSavedData["investigator_details"][0].department && 
            ...
            if (getSavedData["investigator_role_details"] && getSavedData["investigator_role_details"].length>0 ) {
                if (invest_names.length == getSavedData["investigator_role_details"].length) {
                    if (invest_names.length>0) {
                        for(let j=0;j<invest_names.length;j++)
                        {
                            if (!getSavedData["investigator_role_details"][j]) { return false; }
                            if ( invest_names[j].value == getSavedData["investigator_role_details"][j].name ) { } else { return false; }
                            if ( invest_roles[j].value == getSavedData["investigator_role_details"][j].role ) { } else { return false; }
                        }
                    }
                } else { return false; }
            } else { return false; }
            ...
            if (budget_consolidated==getSavedData["budget_consolidated"] &&
                ...
                year_1_1==getSavedData["year_1_1"] && year_1_2==getSavedData["year_1_2"] && year_1_3==getSavedData["year_1_3"] && year_1_total==getSavedData["year_1_total"] && 
                year_2_1==getSavedData["year_2_1"] && year_2_2==getSavedData["year_2_2"] && year_2_3==getSavedData["year_2_3"] && year_2_total==getSavedData["year_2_total"] &&
                year_3_1==getSavedData["year_3_1"] && year_3_2==getSavedData["year_3_2"] && year_3_3==getSavedData["year_3_3"] && year_3_total==getSavedData["year_3_total"] &&
                year_4_1==getSavedData["year_4_1"] && year_4_2==getSavedData["year_4_2"] && year_4_3==getSavedData["year_4_3"] && year_4_total==getSavedData["year_4_total"] &&
                year_5_1==getSavedData["year_5_1"] && year_5_2==getSavedData["year_5_2"] && year_5_3==getSavedData["year_5_3"] && year_5_total==getSavedData["year_5_total"] && 
                year_6_1==getSavedData["year_6_1"] && year_6_2==getSavedData["year_6_2"] && year_6_3==getSavedData["year_6_3"] && year_6_total==getSavedData["year_6_total"] &&
                year_7_1==getSavedData["year_7_1"] && year_7_2==getSavedData["year_7_2"] && year_7_3==getSavedData["year_7_3"] && year_7_total==getSavedData["year_7_total"] &&
                year_8_1==getSavedData["year_8_1"] && year_8_2==getSavedData["year_8_2"] && year_8_3==getSavedData["year_8_3"] && year_8_total==getSavedData["year_8_total"] && 
                year_9_1==getSavedData["year_9_1"] && year_9_2==getSavedData["year_9_2"] && year_9_3==getSavedData["year_9_3"] && year_9_total==getSavedData["year_9_total"] &&
                year_10_1==getSavedData["year_10_1"] && year_10_2==getSavedData["year_10_2"] && year_10_3==getSavedData["year_10_3"] && year_10_total==getSavedData["year_10_total"] &&
                year_11_1==getSavedData["year_11_1"] && year_11_2==getSavedData["year_11_2"] && year_11_3==getSavedData["year_11_3"] && year_11_total==getSavedData["year_11_total"] &&
                year_12_1==getSavedData["year_12_1"] && year_12_2==getSavedData["year_12_2"] && year_12_3==getSavedData["year_12_3"] && year_12_total==getSavedData["year_12_total"] &&
                year_13_1==getSavedData["year_13_1"] && year_13_2==getSavedData["year_13_2"] && year_13_3==getSavedData["year_13_3"] && year_13_total==getSavedData["year_13_total"] &&
                year_14_1==getSavedData["year_14_1"] && year_14_2==getSavedData["year_14_2"] && year_14_3==getSavedData["year_14_3"] && year_14_total==getSavedData["year_14_total"] &&
                year_15_1==getSavedData["year_15_1"] && year_15_2==getSavedData["year_15_2"] && year_15_3==getSavedData["year_15_3"] && year_15_total==getSavedData["year_15_total"] &&
                year_16_1==getSavedData["year_16_1"] && year_16_2==getSavedData["year_16_2"] && year_16_3==getSavedData["year_16_3"] && year_16_total==getSavedData["year_16_total"] &&
                year_17_1==getSavedData["year_17_1"] && year_17_2==getSavedData["year_17_2"] && year_17_3==getSavedData["year_17_3"] && year_17_total==getSavedData["year_17_total"] && 
                isSavedForm_8
            ) {
    ...
    function validateInputType(type, inputFieldId, inputFieldValue) {
        ...
        var checkValidInputForID = ["institute_name","guide_name","invest_name"];
        var allowCharsForID = ["investigators_project_title",
            "investigators_project_title","investigators_project_role","investigators_project_agency","investigators_project_status",
            "investigators_ongoing_project_title","investigators_ongoing_project_role","investigators_ongoing_project_agency",
            "investigators_completed_project_title","investigators_completed_project_role","investigators_completed_project_agency",
            "equipment_a","equipment_b","equipment_c","equipment_d","equipment_e"
        ]; // "broad_discipline", "proposal_title",
        var minCharLenForID = ["official_address","investigator_publication",
                "bibliography","institute_name","institute_address","guide_address","budget_components_justification",
            ];
        ...
        if (minCharLenForID.includes(inputFieldId) || minCharLenForID.includes(trimInputFieldId)) {
            minCharLength = 10;
        }
        
        if (type=='text') {
            if (inputFieldId=="designation" || inputFieldId=="co_inv_i_designation" || inputFieldId=="co_inv_ii_designation" 
                || inputFieldId=="qualification" || inputFieldId=="co_inv_i_qualification" || inputFieldId=="co_inv_ii_qualification" 
                || inputFieldId=="department" || inputFieldId=="co_inv_i_department" || inputFieldId=="co_inv_ii_department" 
            ) {
                minCharLength = 2;
            } else  if ( inputFieldId=="middle_name" || inputFieldId=="co_inv_i_middle_name" || inputFieldId=="co_inv_ii_middle_name" ) {
                minCharLength = 1;
            }
            ...
            if (textValFieldArrID.includes(trimInputFieldId)) {
                if (inputFieldValue == '') {
                    switch (trimInputFieldId) {
                        ...
                        case 'invest_name': msg = 'Name of the Investigators is required'; break;
                        case 'invest_role': msg = 'Roles/Responsibilities of the Investigators is required'; break;
                        default: msg = ''; break;
                    }
                    ...
                    switch (trimInputFieldId) {
                        ...
                        case 'invest_name': msg = 'Name of the Investigators '+msg; break;
                        case 'invest_role': msg = 'Roles/Responsibilities of the Investigators '+msg; break;
                ...
                } else if (!isValidEducationName(inputFieldValue) && (checkValidInputForID.includes(trimInputFieldId) || checkValidInputForID.includes(trimInputFieldId) ) ) {
                    msg = 'Invalid Input !'; 
                } else {
                    msg = '';
                }
                ...
                if (inputFieldValue === '') { 
                    switch (inputFieldId) {
                        ...
                        case 'official_address': msg = 'Please Enter official address'; break;
                        case 'department': msg = 'Department is required'; break;
                        // case 'co_inv_i_first_name': msg = 'First name is required'; break;
                            // case 'co_inv_i_last_name': msg = 'Last name is required'; break;
                            // case 'co_inv_i_phone_no': msg = 'Phone number is required'; break;
                            // case 'co_inv_i_email': msg = 'Email is required'; break;
                            // case 'co_inv_i_designation': msg = 'Designation is required'; break;
                            // case 'co_inv_i_qualification': msg = 'Qualification is required'; break;
                            // case 'co_inv_i_official_address': msg = 'Please Enter official address'; break;
                            // case 'co_inv_ii_first_name': msg = 'First name is required'; break;
                            // case 'co_inv_ii_last_name': msg = 'Last name is required'; break;
                            // case 'co_inv_ii_phone_no': msg = 'Phone number is required'; break;
                            // case 'co_inv_ii_email': msg = 'Email is required'; break;
                            // case 'co_inv_ii_designation': msg = 'Designation is required'; break;
                            // case 'co_inv_ii_qualification': msg = 'Qualification is required'; break;
                            // case 'co_inv_ii_official_address': msg = 'Please Enter official address'; break;
                        // case 'year_12_1': msg = 'Hiring services amount required'; break;
                    }
                    ...
                    switch (inputFieldId) {
                        ...
                        case 'department': msg = 'Department '+msg; break;
                        case 'official_address': msg = 'Address '+msg; break;
                        case 'qualification': msg = 'Qualification '+msg; break;
                        case 'designation': msg = 'Designation '+msg; break;
                        case 'last_name': msg = 'Last '+msg; break;
                        case 'middle_name': msg = 'Name '+msg; break;
                        case 'first_name': msg = 'Name '+msg; break;
                        case 'co_inv_i_specialisation': msg = 'Specialisation '+msg; break;
                        case 'co_inv_i_department': msg = 'Department '+msg; break;
                        case 'co_inv_i_official_address': msg = 'Address '+msg; break;
                        case 'co_inv_i_qualification': msg = 'Qualification '+msg; break;
                        case 'co_inv_i_designation': msg = 'Designation '+msg; break;
                        case 'co_inv_i_last_name': msg = 'Last name '+msg; break;
                        case 'co_inv_i_middle_name': msg = 'Middle name '+msg; break;
                        case 'co_inv_i_first_name': msg = 'First name '+msg; break;
                        case 'co_inv_ii_specialisation': msg = 'Specialisation '+msg; break;
                        case 'co_inv_ii_department': msg = 'Department '+msg; break;
                        case 'co_inv_ii_official_address': msg = 'Address '+msg; break;
                        case 'co_inv_ii_qualification': msg = 'Qualification '+msg; break;
                        case 'co_inv_ii_designation': msg = 'Designation '+msg; break;
                        case 'co_inv_ii_last_name': msg = 'Last name '+msg; break;
                        case 'co_inv_ii_middle_name': msg = 'Middle name '+msg; break;
                        case 'co_inv_ii_first_name': msg = 'First name '+msg; break;
                        ...
                        case 'proposal_title': msg = 'Proposal title  '+msg; break;
                        default: msg = ''; break;
                    }
                } else if (inputFieldValue.length > maxCharLength) {
                    msg = 'Maximum limit of '+maxCharLength+' characters reached for the Input Field!';
            ...
            maxCharLength = 4000;
            // if (inputFieldId=="institute_address"
            //     || inputFieldId=="expected_outcome" || inputFieldId=="objectives" || inputFieldId=="proposal_summary" 
            // ) {
            ...
            if (inputFieldValue === '') {   
                switch (inputFieldId) {
                    ...
                    case 'budget_consolidated': msg = 'Consolidated Budget amount is required'; break;
                    default: msg = ''; break;
                }
    ...
    function getApiResponse(res, type) {
        if (res.flag && res.status=='200') {
            if (type=='save-form') {
                ...
                localStorage.setItem("majorResearchProjectData", JSON.stringify(getSavedData));
                setTimeout(() => {
                ...
                callApi({
                    method: 'GET',
                    url: 'api/schemeMajorResearchProjectApi.php?id='+userId+'&schemeBatchId='+schemeBatchId+'&type=generate-pdf',
