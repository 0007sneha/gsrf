<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $application_no = applicationNo("scheme_doctoral_fellowship");
        ...
        if (isset($postData["formSubmissionType"]) && $postData["formSubmissionType"] == 'direct') {
            ...
            $query="INSERT INTO scheme_doctoral_fellowship (user_id,application_no,scheme_batch_id,file_application_form,form_status)
            ...
            if ($get_last_record_id) {
                // update
                if ($form_no == 0) {
                    $query="UPDATE scheme_doctoral_fellowship SET first_name=:first_name,middle_name=:middle_name,last_name=:last_name,dob=:dob,res_address=:res_address,country_code=:country_code,phone_no=:phone_no,email=:email,
        ...
        if ($form_type=='save-form') {
            ...
            $query="UPDATE scheme_doctoral_fellowship SET form_status=:form_status WHERE id=$get_last_record_id";
            ...
            // acknowledgement Mail
                ...
                $scheme_name = "GSRF Doctoral Research Fellowship Scheme";
            ...
            // save log
                ...
                $log_data = [
                    ...
                    ':sent_by' => 'GSRF',
                    ':application_no' => '',
                    ':title' => 'GSRF Doctoral Research Fellowship Scheme, application submitted by '.$name,
                    ':receiver' => 'Candidate',
