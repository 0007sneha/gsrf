<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        if (isset($type) && $type!="download-pdf") {
            $data = fetchRows("SELECT * FROM scheme_minor_project_grant WHERE status = 1 AND user_id = $id AND scheme_batch_id = $schemeBatchId ORDER BY id DESC ", false);
            if ($data) {
                $getId = $data['id'];
                $data['investigator_details'] = fetchRows("SELECT * FROM scheme_fellowship_investigator_details
                                            WHERE scheme_minor_project_grant_id = $getId
                                        ");
        ...
        if (isset($type) && $type=="preview") {
            ...
            $data = fetchRows("SELECT id, user_id, application_no, file_application_form, status 
                                FROM scheme_minor_project_grant 
                                WHERE status = 1 AND user_id = $id AND scheme_batch_id = $schemeBatchId 
                                ORDER BY id DESC ", false);
            if ($data) {
                echo json_encode(['flag'=>true, 'status'=>'200', 'message'=>'success', 'data'=>$data]);
            } else {
                echo json_encode(['flag'=>false, 'status'=>'500', 'message'=>'Failed to download file', 'data'=>'File not available !']); exit;
            }
            ...
            if ($dev == "filename" || $dev=="displayfile") {
                if ($data["file_application_form"]) {
                    ...
                    // save generated pdf
                    $query = "UPDATE scheme_minor_project_grant SET file_application_form=:file_application_form 
            ...
            $countryCode_data0 = findObjectById($countryCodeArr, $investigatorDetails[0]['country_code']);
            ...
            // create PDF
                $html = $pdf_head_start;
                $html .= '<title>GSRF-Minor Research Project  </title>';
                $html .= $pdf_style;
                $html .= $pdf_head_end;
                $html .= '
                    <body>
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-5">
                                    <h3>Principal Investigator Details  (No Co-PI allowed)</h3>
                                    <table>
                                        <tbody>
                                            ...
                                            <tr><td>Gender</td><td>'.$investigatorDetails[0]["gender"].' </td></tr>
                                            <tr><td>Date of Birth</td><td>'.$dateOfBirth0.' </td></tr>
                                            <tr><td>Mobile No. </td><td>'.$countryCode_data0["name"].' </span>&nbsp;<span>'.$investigatorDetails[0]["phone_no"].' </td></tr>
                                            ...
                                            <tr><td>Official Address</td><td>'.nl2br(htmlspecialchars($investigatorDetails[0]["official_address"])).' </td></tr>
                                            <tr><td>Specialisation(If any) </td><td>'.nl2br(htmlspecialchars($data["specialisation"])).' </td></tr>
                                            <tr><td>User Picture
                                ...
                                <div class="mb-5">
                                    <h3 class="mt-5">Institution Details</h3>
                                    ...
                                    <table>
                                        <tbody>
                                            <tr><td class="fw-5">
                                                ...
                                                <p>Please elaborate on the background and rationale for proposing this work. Not more than 300 words</p>
                                            </td></tr>
                                ...
                                <div class="mb-5">
                                    ...
                                    <table>
                                        <tbody>
                                            <tr><td class="fw-5">International Status
                                            ...
                                            <tr><td class="fw-5">National Status
                                            ...
                                            <tr><td class="fw-5">Local status (if it is a locally relevant proposal)
                                            ...
                                            <tr><td class="fw-5">Significance of the proposal
                                            ...
                                            <tr><td class="fw-5">Is the project location specific? 
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="mb-5">
                                        <table>
                                            <tbody>
                                                <tr><td class="fw-5">Plan of action for utilising research outcome
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <table>
                                            <tbody>
                                                <tr><td class="fw-5">Highlight the specific expertise available with the PI and Co-PIs for executing the project
                                        ...
                                        <p class="fw-5">Important publications by the Investigators related to the theme of the proposal during the last five years</p>
                                        <br>
                                        <label>Give the list of relevant publications only </label>
                                    ...
                                    $html2 .= '</tbody>
                                        ...
                                        <p class="fw-5">Bibliography</p><br>
                                        <label>Please provide all the references cited in the proposal</label>
                                        <table class="border mb-5">
                                            <thead>
                                                <th class="th-width" style="width: 20px !important;">S.No</th>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <p>Details of Project proposals Submitted to various funding agencies</p>
                                        <table class="border mb-5 ">
                                            <thead>
                                                <th class="th-width" style="width: 20px !important;">S.No.</th>
                                        ...
                                        <p>Details of Ongoing Projects</p>
                                        <table class="border mb-5">
                                            <thead>
                                                <th class="th-width" style="width: 20px !important;">S.No.</th>
                                                <th class="th-width">Title</th>
                                        ...
                                        <table class="border edu_details mt-4">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>I</td>
                                                    <td>Non-Recurring</td>
                                                    <td class="year_field_1 non_recuring">'.$data["year_1_1"].'</td>
                                                    <td class="year_field_2 non_recuring">'.$data["year_1_2"].'</td>
                                                    <td>'.$data["year_1_total"].'</td>
                                                </tr>
                                                <tr>
                                                    <td>1</td>
                                                    <td>Equipment</td>
                                                    <td class="year_field_1 non_recuring">'.$data["year_2_1"].'</td>
                                                    <td class="year_field_2 non_recuring">'.$data["year_2_2"].'</td>
                                                    <td>'.$data["year_2_total"].'</td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td>(a)'.$data["equipment_a"].'</td>
                                                    <td class="year_field_1 non_recuring">'.$data["year_3_1"].'</td>
                                                    <td class="year_field_2 non_recuring">'.$data["year_3_2"].'</td>
                                                    <td>'.$data["year_3_total"].'</td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td>(b)'.$data["equipment_b"].'</td>
                                                    <td class="year_field_1 non_recuring">'.$data["year_4_1"].'</td>
                                                    <td class="year_field_2 non_recuring">'.$data["year_4_2"].'</td>
                                                    <td>'.$data["year_4_total"].'</td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td>(c)'.$data["equipment_c"].'</td>
                                                    <td class="year_field_1 non_recuring">'.$data["year_5_1"].'</td>
                                                    <td class="year_field_2 non_recuring">'.$data["year_5_2"].'</td>
                                                    <td>'.$data["year_5_total"].'</td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td>(d)'.$data["equipment_d"].'</td>
                                                    <td class="year_field_1 non_recuring">'.$data["year_6_1"].'</td>
                                                    <td class="year_field_2 non_recuring">'.$data["year_6_2"].'</td>
                                                    <td>'.$data["year_6_total"].'</td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td>(e)'.$data["equipment_e"].'</td>
                                                    <td class="year_field_1 non_recuring">'.$data["year_7_1"].'</td>
                                                    <td class="year_field_2 non_recuring">'.$data["year_7_2"].'</td>
                                                    <td>'.$data["year_7_total"].'</td>
                                                </tr>
                                            ';
                                            // code removed as of 08 june2024 
                                                // <tr class="books_journals_row">
                                                //     <td>2</td>
                                                //     <td>Books and Journals</td>
                                                //     <td class="year_field_1 non_recuring">'.$data["year_8_1"].'</td>
                                                //     <td class="year_field_2 non_recuring">'.$data["year_8_2"].'</td>
                                    ...
                                    $html2 .= '
                                                <tr>
                                                    <td></td>
                                                    <td>TOTAL</td>
                                                    <td class="year_field_1 non_recuring">'.$data["year_9_1"].'</td>
                                                    <td class="year_field_2 non_recuring">'.$data["year_9_2"].'</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="year_field_1">'.$data["year_10_1"].'</td>
                                                    <td class="year_field_2">'.$data["year_10_2"].'</td>
                                                    <td>'.$data["year_10_total"].'</td>
                                                </tr>
                                                <tr>
                                                    <td>3</td>
                                                    <td>Contingency</td>
                                                    <td class="year_field_1">'.$data["year_11_1"].'</td>
                                                    <td class="year_field_2">'.$data["year_11_2"].'</td>
                                                    <td>'.$data["year_11_total"].'</td>
                                                </tr>
                                                <tr>
                                                    <td>4</td>
                                                    <td>Chemicals and consumables</td>
                                                    <td class="year_field_1">'.$data["year_12_1"].'</td>
                                                    <td class="year_field_2">'.$data["year_12_2"].'</td>
                                                    <td>'.$data["year_12_total"].'</td>
                                                </tr>
                                                <tr>
                                                    <td>5</td>
                                                    <td>Travel and/or Field Work</td>
                                                    <td class="year_field_1">'.$data["year_13_1"].'</td>
                                                    <td class="year_field_2">'.$data["year_13_2"].'</td>
                                                    <td>'.$data["year_13_total"].'</td>
                                                </tr>
                                                <tr>
                                                    <td>6</td>
                                                    <td>Special Needs (if any)</td>
                                                    <td class="year_field_1">'.$data["year_14_1"].'</td>
                                                    <td class="year_field_2">'.$data["year_14_2"].'</td>
                                                    <td>'.$data["year_14_total"].'</td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td>Total</td>
                                                    <td class="year_field_1">'.$data["year_15_1"].'</td>
                                                    <td class="year_field_2">'.$data["year_15_2"].'</td>
                                                    <td>'.$data["year_15_total"].'</td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td>Grand Total</td>
                                                    <td class="year_field_1">'.$data["year_16_1"].'</td>
                                                    <td class="year_field_2">'.$data["year_16_2"].'</td>
                                        ...
                                        <label>Budget without proper justification may lead to rejection of the application</label>
                                        <label style="display:none">If more than one institution is involved, please provide institution-wise budget details in addition to the above.</label>
                                        <table class="border">
                                            <thead>
                                                <th class="th-width" style="width: 20px !important;">S.No</th>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <table>
                                            ...
                                            $html2 .= '</td>
                                                ...
                                                <tr><td>Aadhar Card of the PI</td><td></td></tr>
                                                <tr><td>Endorsement from the Principal/Registrar/Head of the Institution</td><td></td></tr>
                                                <tr>
                                                    <td>Are you a non-Ph.D. but a registered PhD student? 
                                                        <p class="p-0">(If yes, then please upload bona fide certificate)</p>
                                                    </td>
                                                    <td>';
                                                        if ($data['is_pi_non_phd']==0 ) {
                                                            $html2 .= 'No';
                                                        } else {
                                                            $html2 .= 'Yes';
                                                        }
                                            $html2 .= '</td>
                                                ...
                                                // if ($data['file_pi_bona_fide_certificate']==1) {
                                                //     $html2 .= '<tr><td>Bona-fide Certificate for the registered PhD student</td><td></td></tr>';
                                                // }
                                                // if ($data['is_pi_belong_to_category']==1) {
                                                //     $html2 .= '<tr><td>Category Certificate</td><td></td></tr>';
                                                // }
                                                // if ($data['is_pi_differently_abled']==1) {
                                                //     $html2 .= '<tr><td>Differently Abled Certificate</td><td></td></tr>';
                                                // }
                                    $html2 .= '</tbody>
                                        </table>
                                    </div>
            ...
            // merge all the files to attach 
                ...
                if ($data['is_pi_non_phd']==1) {
                    array_push($file_to_merge, $base_path.$data['file_pi_bona_fide_certificate']);
                }
                array_push($file_to_merge, $base_path.$data['file_pi_cv']);

                // $base_path.$data['file_registrar_endorsement_certificate'],
                // $base_path.$data['file_head_inst_endorsement_certificate'],
            // echo '<pre>';print_r($file_to_merge); exit; // removed
            ...
            // Create a new PDF instance
                ...
                try {
                    ...
                    if ($dev=="displayfile") {
                        ...
                        // save generated pdf
                        $query = "UPDATE scheme_minor_project_grant SET file_application_form=:file_application_form WHERE user_id='".$id."' ";
                        $data_update = array(
                                ':file_application_form' => $pdf_file_location,
                            );
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $application_no = applicationNo("scheme_minor_project_grant");
        ...
        if (isset($postData["formSubmissionType"]) && $postData["formSubmissionType"] == 'direct') {
            ...
            $query="INSERT INTO scheme_minor_project_grant (user_id,application_no,scheme_batch_id,file_application_form,form_status)
            ...
            $investigator_details = $postData['investigator_details'] ?? [];
                ...
                $file_head_inst_endorsement_certificate = $postData['file_head_inst_endorsement_certificate'] ?? '';
                $is_pi_non_phd = $postData['is_pi_non_phd'] ?? '';
                $file_pi_bona_fide_certificate = $postData['file_pi_bona_fide_certificate'] ?? '';
            $file_pi_cv = $postData['file_pi_cv'] ?? '';
            
            if ($get_last_record_id) {
                // update
                if ($form_no == 0) {
                    $query="UPDATE scheme_minor_project_grant SET specialisation=:specialisation,file_profile_picture=:file_profile_picture,proposed_amount=:proposed_amount,form_no=:form_no WHERE id=$get_last_record_id";
                    $data = array(
                    ...
                    if($result)
                    {
                        ...
                        if ($investigator_details) {
                            if (fetchRows("SELECT * FROM scheme_fellowship_investigator_details WHERE scheme_minor_project_grant_id = $get_last_record_id")) {
                                deleteRow("DELETE FROM scheme_fellowship_investigator_details WHERE scheme_minor_project_grant_id = $get_last_record_id");
                            }
                            $query2="INSERT INTO scheme_fellowship_investigator_details (scheme_minor_project_grant_id, type, first_name, middle_name, last_name, gender, dob, qualification, designation, official_address, country_code, phone_no, email ) 
                                            VALUES (:scheme_minor_project_grant_id, :type, :first_name, :middle_name, :last_name, :gender, :dob, :qualification, :designation, :official_address, :country_code, :phone_no, :email )";
                            foreach ($investigator_details as $key => $value) {
                                $data2 = array(
                                            ':scheme_minor_project_grant_id' => $get_last_record_id,
                                            ':type' => $value['type'],
                        ...
                        if ($institution_details) {
                            if (fetchRows("SELECT * FROM scheme_institution_details WHERE scheme_minor_project_grant_id = $get_last_record_id")) {
                                deleteRow("DELETE FROM scheme_institution_details WHERE scheme_minor_project_grant_id = $get_last_record_id");
                            }
                            $query2="INSERT INTO scheme_institution_details (scheme_minor_project_grant_id, name, address) 
                                        VALUES (:scheme_minor_project_grant_id, :name, :address )";
                    ...
                    $query="UPDATE scheme_minor_project_grant 
                    ...
                    $result = insertRow($query, $data);
                    if($result) {
                        if (fetchRows("SELECT * FROM scheme_important_publications_details WHERE scheme_minor_project_grant_id = $get_last_record_id")) {
                            deleteRow("DELETE FROM scheme_important_publications_details WHERE scheme_minor_project_grant_id = $get_last_record_id");
                        }
                        if ($investigator_publications_details) {
                            $query2="INSERT INTO scheme_important_publications_details (scheme_minor_project_grant_id, name) 
                                        VALUES (:scheme_minor_project_grant_id, :name)";
                        ...
                        if (fetchRows("SELECT * FROM scheme_important_reference_details WHERE scheme_minor_project_grant_id = $get_last_record_id")) {
                            deleteRow("DELETE FROM scheme_important_reference_details WHERE scheme_minor_project_grant_id = $get_last_record_id");
                        }
                        if ($bibliography_details) {
                            $query3="INSERT INTO scheme_important_reference_details (scheme_minor_project_grant_id, name) 
                                        VALUES (:scheme_minor_project_grant_id, :name)";
                    ...
                    $query="UPDATE scheme_minor_project_grant SET form_no=:form_no WHERE id=$get_last_record_id";
                    $data = array(':form_no' => $form_no );
                    $result = insertRow($query, $data);

                    // get table if exist -- delete rows if exist -- create new
                    if (fetchRows("SELECT * FROM scheme_project_details WHERE scheme_minor_project_grant_id = $get_last_record_id")) {
                        deleteRow("DELETE FROM scheme_project_details WHERE scheme_minor_project_grant_id = $get_last_record_id");
                    }
                    $query_project_1="INSERT INTO scheme_project_details (scheme_minor_project_grant_id, project_status, type, title, cost_in_lakhs, submission_month, role, agency, status) 
                            VALUES (:scheme_minor_project_grant_id, :project_status, :type, :title, :cost_in_lakhs, :submission_month, :role, :agency, :status)";
                    ...
                    $query_project="INSERT INTO scheme_project_details (scheme_minor_project_grant_id, project_status, type, title, cost_in_lakhs, start_date, end_date, role, agency) 
                                VALUES (:scheme_minor_project_grant_id, :project_status, :type, :title, :cost_in_lakhs, :start_date, :end_date, :role, :agency)";
                    ...
                    // get table if exist -- delete rows if exist -- create new
                    if (fetchRows("SELECT * FROM scheme_infrastructural_facility_details WHERE scheme_minor_project_grant_id = $get_last_record_id")) {
                        deleteRow("DELETE FROM scheme_infrastructural_facility_details WHERE scheme_minor_project_grant_id = $get_last_record_id");
                    }
                    if ($infrastructural_facility_details) {
                        $query2="INSERT INTO scheme_infrastructural_facility_details (scheme_minor_project_grant_id, title, status) 
                                    VALUES (:scheme_minor_project_grant_id, :title, :status)";
                    ...
                    if (fetchRows("SELECT * FROM scheme_equipment_details WHERE scheme_minor_project_grant_id = $get_last_record_id")) {
                        deleteRow("DELETE FROM scheme_equipment_details WHERE scheme_minor_project_grant_id = $get_last_record_id");
                    }
                    if ($equipment_details) {
                        $query2="INSERT INTO scheme_equipment_details (scheme_minor_project_grant_id, available_with, generic_name, purchase_details, remarks_on_accessories) 
                                    VALUES (:scheme_minor_project_grant_id, :available_with, :generic_name, :purchase_details, :remarks_on_accessories)";
                    ...
                    if (fetchRows("SELECT * FROM scheme_project_outcome_interested_expert_details WHERE scheme_minor_project_grant_id = $get_last_record_id")) {
                        deleteRow("DELETE FROM scheme_project_outcome_interested_expert_details WHERE scheme_minor_project_grant_id = $get_last_record_id");
                    }
                    if ($outcome_interested_expert_details) {
                        foreach ($outcome_interested_expert_details as $key => $value) {
                            $query2="INSERT INTO scheme_project_outcome_interested_expert_details (scheme_minor_project_grant_id, name, address) 
                                        VALUES (:scheme_minor_project_grant_id, :name, :address)";
                            $data2 = array(
                                        ':scheme_minor_project_grant_id' => $get_last_record_id,
                                        ':name' => $value['name'],
                    ...
                    $query="UPDATE scheme_minor_project_grant 
                            SET proposed_amount=:proposed_amount, budget_consolidated=:budget_consolidated, equipment_a=:equipment_a, equipment_b=:equipment_b, equipment_c=:equipment_c, equipment_d=:equipment_d, equipment_e=:equipment_e,
                                year_1_1=:year_1_1, year_1_2=:year_1_2, year_1_total=:year_1_total, year_2_1=:year_2_1, year_2_2=:year_2_2, year_2_total=:year_2_total, 
                                year_3_1=:year_3_1, year_3_2=:year_3_2, year_3_total=:year_3_total, year_4_1=:year_4_1, year_4_2=:year_4_2, year_4_total=:year_4_total, 
                                year_5_1=:year_5_1, year_5_2=:year_5_2, year_5_total=:year_5_total, year_6_1=:year_6_1, year_6_2=:year_6_2, year_6_total=:year_6_total, 
                                year_7_1=:year_7_1, year_7_2=:year_7_2, year_7_total=:year_7_total, year_8_1=:year_8_1, year_8_2=:year_8_2, year_8_total=:year_8_total, 
                                year_9_1=:year_9_1, year_9_2=:year_9_2, year_9_total=:year_9_total, year_10_1=:year_10_1, year_10_2=:year_10_2, year_10_total=:year_10_total, 
                                year_11_1=:year_11_1, year_11_2=:year_11_2, year_11_total=:year_11_total, year_12_1=:year_12_1, year_12_2=:year_12_2, year_12_total=:year_12_total, 
                                year_13_1=:year_13_1, year_13_2=:year_13_2, year_13_total=:year_13_total, year_14_1=:year_14_1, year_14_2=:year_14_2, year_14_total=:year_14_total, 
                                year_15_1=:year_15_1, year_15_2=:year_15_2, year_15_total=:year_15_total, year_16_1=:year_16_1, year_16_2=:year_16_2, year_16_total=:year_16_total, 
                                budget_project_relevance=:budget_project_relevance,form_no=:form_no
                            WHERE id=$get_last_record_id";
                    $data = array(
                    ...
                    if ($result) {
                        if ($budget_components_details) {
                            if (fetchRows("SELECT * FROM scheme_budget_components_details WHERE scheme_minor_project_grant_id = $get_last_record_id")) {
                                deleteRow("DELETE FROM scheme_budget_components_details WHERE scheme_minor_project_grant_id = $get_last_record_id");
                            }
                            $query2="INSERT INTO scheme_budget_components_details (scheme_minor_project_grant_id, name, description) 
                                        VALUES (:scheme_minor_project_grant_id, :name, :description )";
                    ...
                    $query="UPDATE scheme_minor_project_grant 
                            SET is_pi_belong_to_category=:is_pi_belong_to_category, file_category_certificate=:file_category_certificate, is_pi_differently_abled=:is_pi_differently_abled, file_pi_diff_abled_certificate=:file_pi_diff_abled_certificate, 
                                ...
                                file_head_inst_endorsement_certificate=:file_head_inst_endorsement_certificate, 
                                is_pi_non_phd=:is_pi_non_phd, file_pi_bona_fide_certificate=:file_pi_bona_fide_certificate, file_pi_cv=:file_pi_cv, form_no=:form_no
                            WHERE id=$get_last_record_id";
                    $data = array(
                                ...
                                ':file_head_inst_endorsement_certificate' => $file_head_inst_endorsement_certificate,
                                ':is_pi_non_phd' => $is_pi_non_phd,
                                ':file_pi_bona_fide_certificate' => $file_pi_bona_fide_certificate,
                ...
                // create
                $query="INSERT INTO scheme_minor_project_grant (user_id,application_no,scheme_batch_id,specialisation,file_profile_picture,proposed_amount,form_no)
                        VALUES (:user_id,:application_no,:scheme_batch_id,:specialisation,:file_profile_picture,:proposed_amount,:form_no)";
                $data = array(
                        ':user_id' => $user_id,
                        ':application_no' => $application_no,
                        ':scheme_batch_id' => $scheme_batch_id,
                ...
                {
                    // get last id
                    $query = "SELECT id FROM scheme_minor_project_grant ORDER BY id DESC LIMIT 1";
        ...
        if ($form_type=='save-form') {
            ...
            $query="UPDATE scheme_minor_project_grant SET form_status=:form_status WHERE id=$get_last_record_id";
            ...
            // save log
                ...
                $log_data = [
                    ...
                    ':sent_by' => 'GSRF',
                    ':application_no' => '',
                    ':title' => 'GSRF Minor Research Grant Scheme, application submitted by '.$name,
                    ':receiver' => 'Candidate',
