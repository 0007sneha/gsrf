...
if (isset($_SESSION['reviewer_admin_logged_in']) && $_SESSION['reviewer_admin_logged_in'] === TRUE) {
          ...
          <div class="col-md-6 d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="card mb-3 py-3">
              <div class="card-body px-4">
                <div class="pb-2">
                  <h5 class="card-title text-center pb-0 fs-4">Reviewer Login</h5>
                </div>
                ...
                <form class="row g-3 needs-validation" novalidate="" method="POST" action="authenticate.php">
                  <div class="col-12">
                    ...
                    <div class="input-group has-validation">
                      ...
                      <input type="text" name="username" class="form-control" id="yourUsername" required="" autofill="off">
