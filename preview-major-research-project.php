                    ...
                    <div class="row">
                        <div class="col-12">
                            <ol>
                                ...
                                <li>Schemes</li>
                                <li><a href="<?php echo $schemeUrl;?>">Major Research Project</a></li>
        ...
        <div class="container">
            <div class="row d-flex justify-content-md-center content-wrap">
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-10 inner-forms">
                    ...
                    <div class="forms">
                        <div class="row">
                            <h3 class="mb-5">Co-Investigator I Details</h3>
                            <div class="col-md-4 mb-4">
                                <label>First Name : </label>
                                <div id="co_inv_i_first_name"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Middle Name : </label>
                                <div id="co_inv_i_middle_name"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Last Name : </label>
                                <div id="co_inv_i_last_name"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Gender : </label>
                                <div id="co_inv_i_gender"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Date of Birth : </label>
                                <div id="co_inv_i_dob"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label class="col-md-12">Mobile No. : </label>
                                <span id="co_inv_i_country_code"> </span>&nbsp;<span id="co_inv_i_phone_no"> </span>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Email ID : </label>
                                <div id="co_inv_i_email"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Designation : </label>
                                <div id="co_inv_i_designation"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Qualification (Highest) : </label>
                                <div id="co_inv_i_qualification"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Official Address : </label>
                                <div id="co_inv_i_official_address"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Department : </label>
                                <div id="co_inv_i_department"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Specialisation(if any) : </label>
                                <div id="co_inv_i_specialisation"> </div>
                            </div>
                        </div>
                    </div>
                    <div class="forms">
                        <div class="row">
                            <h3 class="mb-5">Co-Investigator II Details</h3>
                            <div class="col-md-4 mb-4">
                                <label>First Name : </label>
                                <div id="co_inv_ii_first_name"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Middle Name : </label>
                                <div id="co_inv_ii_middle_name"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Last Name : </label>
                                <div id="co_inv_ii_last_name"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Gender : </label>
                                <div id="co_inv_ii_gender"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Date of Birth : </label>
                                <div id="co_inv_ii_dob"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label class="col-md-12">Mobile No. : </label>
                                <span id="co_inv_ii_country_code"> </span>&nbsp;<span id="co_inv_ii_phone_no"> </span>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Email ID : </label>
                                <div id="co_inv_ii_email"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Designation : </label>
                                <div id="co_inv_ii_designation"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Qualification (Highest) : </label>
                                <div id="co_inv_ii_qualification"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Official Address : </label>
                                <div id="co_inv_ii_official_address"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Department : </label>
                                <div id="co_inv_ii_department"> </div>
                            </div>
                            <div class="col-md-4 mb-4">
                                <label>Specialisation(if any) : </label>
                                <div id="co_inv_ii_specialisation"> </div>
                            </div>
                        </div>
                    </div>
                    <div class="forms">
                    ...
                    <div class="forms">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-5">
                                ...
                                <p>Please provide all the Consolidated (Grand Total)</p>
                            ...
                            <table class="table table-stripped table-bordered border-light edu_details budget_table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="year_field_3 non_recuring"><div id="year_1_3"> </div></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="year_field_3 non_recuring"><div id="year_2_3"> </div></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="year_field_3 non_recuring"><div id="year_3_3"> </div></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="year_field_3 non_recuring"><div id="year_4_3"> </div></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="year_field_3 non_recuring"><div id="year_5_3"> </div></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="year_field_3 non_recuring"><div id="year_6_3"> </div></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="year_field_3 non_recuring"><div id="year_7_3"> </div></td>
                                    ...
                                    <tr class="books_journals_row">
                                        ...
                                        <td class="year_field_3 non_recuring"><div id="year_8_3"> </div></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="year_field_3 non_recuring"><div id="year_9_3"> </div></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="year_field_3"><div id="year_10_3"> </div></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="year_field_3"><div id="year_11_3"> </div></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="year_field_3"><div id="year_12_3"> </div></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="year_field_3"><div id="year_13_3"> </div></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="year_field_3"><div id="year_16_3"> </div></td>
                                        <td><div id="year_16_total"> </div></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>Grand Total</td>
                                        <td class="year_field_1"><div id="year_17_1"> </div></td>
                                        <td class="year_field_2"><div id="year_17_2"> </div></td>
                                        <td class="year_field_3"><div id="year_17_3"> </div></td>
                                        <td><div id="year_17_total"> </div></td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="forms">
                        ...
                        <!-- <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label class="d-block">PhD Certificate </label>
                                <a href="#" class="btn btn-outline" id="view_file_phd_certificate" target="_blank">View File(<span></span>)</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6" id="div_file_co_pi_cv">
                                <label class="d-block">CV of the Co-PIs  <br> (Merge the CV in case more than 1 Co-PIs)</label>
                                <a href="#" class="btn btn-outline" id="view_file_co_pi_cv" target="_blank">View File(<span></span>)</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        if (res.flag && res.status=='200') {
            ...
            if (type=='download-pdf') {
                ...
                let max_fields_bibliography = 
                    max_fields_budgetComponentsDetails = 
                ...
                data['investigator_details'].forEach(element => {
                    ...
                    switch (element.type) {
                        ...
                        case "co_investigator_i" : pre_id='co_inv_i_'; break;
                        case "co_investigator_ii" : pre_id='co_inv_ii_'; break;
                        default: break;
                    }
                    ...
                    if (element['first_name']=="" && (element['email']=="" || element['phone_no']=="") && element['designation']=="" && element['qualification']=="") {} else {
                    ...
                    $("#"+pre_id+"department").text(element['department']);
                    $("#"+pre_id+"specialisation").html(escapeHtml(element['specialisation']));
                });
                ...
                if (data["file_methodology"]) {
                    ...
                    $("#file_methodology_field").addClass("d-none");
                }
                ...
                if ( !data["investigator_role_details"] || data["investigator_role_details"] == "null" ) {} else {
                    data["investigator_role_details"].forEach(investigatorRoleDetail => {
                        x_investExpertise++; 								//text box increment
                        $(wrapper_investExpertise).append(`
                            <tr>
                                <td>${x_investExpertise}</td>
                                <td>${investigatorRoleDetail['name']}</td>
                                <td>${investigatorRoleDetail['role']} </td>
                            </tr>
                        `); //add input box
                    });
                }
                ...
                $("#budget_project_relevance").html(escapeHtml(data["budget_project_relevance"]));
                ...
                for (let index = 1; index <= 17; index++) {
                    ...
                    $("#year_"+tempNo+"_3").text(data["year_"+tempNo+"_3"]);
                ...
                // }
                if (data["file_phd_certificate"]) {
                    displayUploadedFile('docs', 'file_phd_certificate', data["file_phd_certificate"]);
                }
                if (data["file_pi_cv"]) {
                    displayUploadedFile('docs', 'file_pi_cv', data["file_pi_cv"]);
                }
                if (data["file_co_pi_cv"]) {
                    displayUploadedFile('docs', 'file_co_pi_cv', data["file_co_pi_cv"]);
                } else {
                    $("#div_file_co_pi_cv").addClass("d-none");
                }
            }
        } else {
            popUpMsg(res.message);
